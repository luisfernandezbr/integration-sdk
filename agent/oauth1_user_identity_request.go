...
const (
	...
	// Oauth1UserIdentityRequestModelSessionIDColumn is the column json value session_id
	Oauth1UserIdentityRequestModelSessionIDColumn = "session_id"
	// Oauth1UserIdentityRequestModelTokenColumn is the column json value token
	Oauth1UserIdentityRequestModelTokenColumn = "token"
	// Oauth1UserIdentityRequestModelTokenSecretColumn is the column json value token_secret
	Oauth1UserIdentityRequestModelTokenSecretColumn = "token_secret"
...
type Oauth1UserIdentityRequest struct {
	...
	// TokenSecret the user acces token secret
...
func (o *Oauth1UserIdentityRequest) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"session_id":              toOauth1UserIdentityRequestObject(o.SessionID, false),
		"token":                   toOauth1UserIdentityRequestObject(o.Token, true),
		"token_secret":            toOauth1UserIdentityRequestObject(o.TokenSecret, true),
...
func (o *Oauth1UserIdentityRequestPartial) ToMap() map[string]interface{} {
	kv := map[string]interface{}{
		...
		"session_id":      toOauth1UserIdentityRequestObject(o.SessionID, true),
		"token":           toOauth1UserIdentityRequestObject(o.Token, true),
		"token_secret":    toOauth1UserIdentityRequestObject(o.TokenSecret, true),
