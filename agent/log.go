...
type Log struct {
	...
	EventDate LogEventDate `json:"event_date" yaml:"event_date" faker:"-"`
	...
	LastExportDate LogLastExportDate `json:"last_export_date" yaml:"last_export_date" faker:"-"`
	...
	Type LogType `json:"type" yaml:"type" faker:"-"`
