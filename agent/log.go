...
func (o *Log) MarshalBinary() ([]byte, error) {
	return o.MarshalJSON()
}

func (o *Log) UnmarshalBinary(data []byte) error {
...
var cachedCodecLogLock sync.Mutex

// GetAvroCodec returns the avro codec for this model
func (o *Log) GetAvroCodec() *goavro.Codec {
	cachedCodecLogLock.Lock()
...
func (o *Log) ToMap(avro ...bool) map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"system_id":        toLogObject(o.SystemID, isavro, false, "string"),
