...
const (
	...
	// RepoResponseModelIntegrationInstanceIDColumn is the column json value integration_instance_id
	RepoResponseModelIntegrationInstanceIDColumn = "integration_instance_id"
...
// toRepoResponseReposErrorPointer is the enumeration pointer type for error
func toRepoResponseReposErrorPointer(v int32) *RepoResponseReposError {
	nv := RepoResponseReposError(v)
	return &nv
}

// toRepoResponseReposErrorEnum is the enumeration pointer wrapper for error
func toRepoResponseReposErrorEnum(v *RepoResponseReposError) string {
	if v == nil {
		return toRepoResponseReposErrorPointer(0).String()
	}
	return v.String()
}
...
// toRepoResponseTypePointer is the enumeration pointer type for type
func toRepoResponseTypePointer(v int32) *RepoResponseType {
	nv := RepoResponseType(v)
	return &nv
}

// toRepoResponseTypeEnum is the enumeration pointer wrapper for type
func toRepoResponseTypeEnum(v *RepoResponseType) string {
	if v == nil {
		return toRepoResponseTypePointer(0).String()
	}
	return v.String()
}
...
func (o *RepoResponse) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"integration_instance_id": toRepoResponseObject(o.IntegrationInstanceID, true),
...
func (o *RepoResponsePartial) ToMap() map[string]interface{} {
	kv := map[string]interface{}{
		...
		"type":    toRepoResponseTypeEnum(o.Type),
	...
	for k, v := range kv {
		if v == nil || reflect.ValueOf(v).IsZero() {
			...
			if k == "event_date" {
				if dt, ok := v.(*RepoResponseEventDate); ok {
			...
			if k == "last_export_date" {
				if dt, ok := v.(*RepoResponseLastExportDate); ok {
					if dt.Epoch == 0 && dt.Offset == 0 && dt.Rfc3339 == "" {
						delete(kv, k)
					}
				}
			...
			if k == "repos" {
				if arr, ok := v.([]RepoResponseRepos); ok {
					if len(arr) == 0 {
						delete(kv, k)
					}
				}
...
// MarshalJSON returns the bytes for marshaling to json
func (o *RepoResponsePartial) MarshalJSON() ([]byte, error) {
	return json.Marshal(o.ToMap())
}

// UnmarshalJSON will unmarshal the json buffer into the object
func (o *RepoResponsePartial) UnmarshalJSON(data []byte) error {
	kv := make(map[string]interface{})
	if err := json.Unmarshal(data, &kv); err != nil {
		return err
	}
...
func (o *RepoResponsePartial) setDefaults(frommap bool) {
}

// FromMap attempts to load data into object from a map
func (o *RepoResponsePartial) FromMap(kv map[string]interface{}) {
	if val, ok := kv["architecture"].(*string); ok {
		o.Architecture = val
	...
	if o.LastExportDate == nil {
		o.LastExportDate = &RepoResponseLastExportDate{}
	}
	...
	if val, ok := kv["type"].(*RepoResponseType); ok {
		o.Type = val
	} else if val, ok := kv["type"].(RepoResponseType); ok {
		o.Type = &val
	} else {
		if val, ok := kv["type"]; ok {
			if val == nil {
				o.Type = toRepoResponseTypePointer(0)
			} else {
				// if coming in as map, convert it back
				if kv, ok := val.(map[string]interface{}); ok {
					val = kv["RepoResponseType"]
				}
				...
				if em, ok := val.(string); ok {
					...
					case "enroll", "ENROLL":
						o.Type = toRepoResponseTypePointer(0)
					case "ping", "PING":
						o.Type = toRepoResponseTypePointer(1)
					case "crash", "CRASH":
						o.Type = toRepoResponseTypePointer(2)
					case "log", "LOG":
						o.Type = toRepoResponseTypePointer(3)
					case "integration", "INTEGRATION":
						o.Type = toRepoResponseTypePointer(4)
					case "export", "EXPORT":
						o.Type = toRepoResponseTypePointer(5)
					case "project", "PROJECT":
						o.Type = toRepoResponseTypePointer(6)
					case "repo", "REPO":
						o.Type = toRepoResponseTypePointer(7)
					case "user", "USER":
						o.Type = toRepoResponseTypePointer(8)
					case "calendar", "CALENDAR":
						o.Type = toRepoResponseTypePointer(9)
					case "uninstall", "UNINSTALL":
						o.Type = toRepoResponseTypePointer(10)
					case "upgrade", "UPGRADE":
						o.Type = toRepoResponseTypePointer(11)
					case "start", "START":
						o.Type = toRepoResponseTypePointer(12)
					case "stop", "STOP":
						o.Type = toRepoResponseTypePointer(13)
					case "pause", "PAUSE":
						o.Type = toRepoResponseTypePointer(14)
					case "resume", "RESUME":
						o.Type = toRepoResponseTypePointer(15)
					}
				}
			}
		}
