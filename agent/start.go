...
const (
	...
	StartCustomerIDColumn = "CustomerID"
...
type Start struct {
	...
	EventDate StartEventDate `json:"event_date" yaml:"event_date" faker:"-"`
	...
	LastExportDate StartLastExportDate `json:"last_export_date" yaml:"last_export_date" faker:"-"`
	...
	Type StartType `json:"type" yaml:"type" faker:"-"`
