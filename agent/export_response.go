...
// toExportResponseIntegrationsExportTypePointer is the enumeration pointer type for export_type
func toExportResponseIntegrationsExportTypePointer(v int32) *ExportResponseIntegrationsExportType {
	nv := ExportResponseIntegrationsExportType(v)
	return &nv
}

// toExportResponseIntegrationsExportTypeEnum is the enumeration pointer wrapper for export_type
func toExportResponseIntegrationsExportTypeEnum(v *ExportResponseIntegrationsExportType) string {
	if v == nil {
		return toExportResponseIntegrationsExportTypePointer(0).String()
	}
	return v.String()
}
...
// toExportResponseIntegrationsSystemTypePointer is the enumeration pointer type for system_type
func toExportResponseIntegrationsSystemTypePointer(v int32) *ExportResponseIntegrationsSystemType {
	nv := ExportResponseIntegrationsSystemType(v)
	return &nv
}

// toExportResponseIntegrationsSystemTypeEnum is the enumeration pointer wrapper for system_type
func toExportResponseIntegrationsSystemTypeEnum(v *ExportResponseIntegrationsSystemType) string {
	if v == nil {
		return toExportResponseIntegrationsSystemTypePointer(0).String()
	}
	return v.String()
}
...
// toExportResponseStatePointer is the enumeration pointer type for state
func toExportResponseStatePointer(v int32) *ExportResponseState {
	nv := ExportResponseState(v)
	return &nv
}

// toExportResponseStateEnum is the enumeration pointer wrapper for state
func toExportResponseStateEnum(v *ExportResponseState) string {
	if v == nil {
		return toExportResponseStatePointer(0).String()
	}
	return v.String()
}
...
// toExportResponseTypePointer is the enumeration pointer type for type
func toExportResponseTypePointer(v int32) *ExportResponseType {
	nv := ExportResponseType(v)
	return &nv
}

// toExportResponseTypeEnum is the enumeration pointer wrapper for type
func toExportResponseTypeEnum(v *ExportResponseType) string {
	if v == nil {
		return toExportResponseTypePointer(0).String()
	}
	return v.String()
}
...
type ExportResponsePartial struct {
	...
	// EndDate the export end date
	EndDate *ExportResponseEndDate `json:"end_date,omitempty"`
	// Error an error message related to this event
	Error *string `json:"error,omitempty"`
	// EventDate the date of the event
	EventDate *ExportResponseEventDate `json:"event_date,omitempty"`
	// FreeSpace the amount of free space in bytes for the agent machine
	...
	// Integrations the integrations that were exported
	Integrations []ExportResponseIntegrations `json:"integrations,omitempty"`
	// JobID The job ID
	JobID *string `json:"job_id,omitempty"`
	// LastExportDate the last export date
	LastExportDate *ExportResponseLastExportDate `json:"last_export_date,omitempty"`
	// Memory the amount of memory in bytes for the agent machine
	...
	// StartDate the export start date
	StartDate *ExportResponseStartDate `json:"start_date,omitempty"`
	// State the state of the response
	State *ExportResponseState `json:"state,omitempty"`
	// Success if the response was successful
	Success *bool `json:"success,omitempty"`
	// SystemID system unique device ID
	SystemID *string `json:"system_id,omitempty"`
	// Type the type of event
	Type *ExportResponseType `json:"type,omitempty"`
	// UploadPartCount the number of parts that the upload sent to the agent upload server
	UploadPartCount *int64 `json:"upload_part_count,omitempty"`
	// UploadURL the upload URL where the job was placed. will be NULL if not uploaded
...
var _ datamodel.PartialModel = (*ExportResponsePartial)(nil)

// GetModelName returns the name of the model
func (o *ExportResponsePartial) GetModelName() datamodel.ModelNameType {
	return ExportResponseModelName
}

// ToMap returns the object as a map
func (o *ExportResponsePartial) ToMap() map[string]interface{} {
	kv := map[string]interface{}{
		"architecture":     toExportResponseObject(o.Architecture, true),
		"data":             toExportResponseObject(o.Data, true),
		"distro":           toExportResponseObject(o.Distro, true),
		"end_date":         toExportResponseObject(o.EndDate, true),
		"error":            toExportResponseObject(o.Error, true),
		"event_date":       toExportResponseObject(o.EventDate, true),
		"free_space":       toExportResponseObject(o.FreeSpace, true),
		"go_version":       toExportResponseObject(o.GoVersion, true),
		"hostname":         toExportResponseObject(o.Hostname, true),
		"integrations":     toExportResponseObject(o.Integrations, true),
		"job_id":           toExportResponseObject(o.JobID, true),
		"last_export_date": toExportResponseObject(o.LastExportDate, true),
		"memory":           toExportResponseObject(o.Memory, true),
		"message":          toExportResponseObject(o.Message, true),
		"num_cpu":          toExportResponseObject(o.NumCPU, true),
		"os":               toExportResponseObject(o.OS, true),
		"request_id":       toExportResponseObject(o.RequestID, true),
		"size":             toExportResponseObject(o.Size, true),
		"start_date":       toExportResponseObject(o.StartDate, true),

		"state":     toExportResponseStateEnum(o.State),
		"success":   toExportResponseObject(o.Success, true),
		"system_id": toExportResponseObject(o.SystemID, true),

		"type":              toExportResponseTypeEnum(o.Type),
		"upload_part_count": toExportResponseObject(o.UploadPartCount, true),
		"upload_url":        toExportResponseObject(o.UploadURL, true),
		"uptime":            toExportResponseObject(o.Uptime, true),
		"uuid":              toExportResponseObject(o.UUID, true),
		"version":           toExportResponseObject(o.Version, true),
	}
	for k, v := range kv {
		if v == nil || reflect.ValueOf(v).IsZero() {
			...
			if k == "end_date" {
				if dt, ok := v.(*ExportResponseEndDate); ok {
			...
			if k == "event_date" {
				if dt, ok := v.(*ExportResponseEventDate); ok {
					if dt.Epoch == 0 && dt.Offset == 0 && dt.Rfc3339 == "" {
						delete(kv, k)
					}
				}
			...
			if k == "integrations" {
				if arr, ok := v.([]ExportResponseIntegrations); ok {
					if len(arr) == 0 {
						delete(kv, k)
					}
				}
			...
			if k == "last_export_date" {
				if dt, ok := v.(*ExportResponseLastExportDate); ok {
					if dt.Epoch == 0 && dt.Offset == 0 && dt.Rfc3339 == "" {
						delete(kv, k)
					}
				}
			...
			if k == "start_date" {
				if dt, ok := v.(*ExportResponseStartDate); ok {
					if dt.Epoch == 0 && dt.Offset == 0 && dt.Rfc3339 == "" {
						delete(kv, k)
					}
				}
...
// Stringify returns the object in JSON format as a string
func (o *ExportResponsePartial) Stringify() string {
	return pjson.Stringify(o.ToMap())
}

// MarshalJSON returns the bytes for marshaling to json
func (o *ExportResponsePartial) MarshalJSON() ([]byte, error) {
	return json.Marshal(o.ToMap())
}

// UnmarshalJSON will unmarshal the json buffer into the object
func (o *ExportResponsePartial) UnmarshalJSON(data []byte) error {
	kv := make(map[string]interface{})
	if err := json.Unmarshal(data, &kv); err != nil {
		return err
	}
...
func (o *ExportResponsePartial) setDefaults(frommap bool) {
}

// FromMap attempts to load data into object from a map
func (o *ExportResponsePartial) FromMap(kv map[string]interface{}) {
	if val, ok := kv["architecture"].(*string); ok {
		o.Architecture = val
	...
	if o.LastExportDate == nil {
		o.LastExportDate = &ExportResponseLastExportDate{}
	}
	...
	if val, ok := kv["state"].(*ExportResponseState); ok {
		o.State = val
	} else if val, ok := kv["state"].(ExportResponseState); ok {
		o.State = &val
	} else {
		if val, ok := kv["state"]; ok {
			if val == nil {
				o.State = toExportResponseStatePointer(0)
			} else {
				// if coming in as map, convert it back
				if kv, ok := val.(map[string]interface{}); ok {
					val = kv["ExportResponseState"]
				}
				...
				if em, ok := val.(string); ok {
					...
					case "starting", "STARTING":
						o.State = toExportResponseStatePointer(0)
					case "progress", "PROGRESS":
						o.State = toExportResponseStatePointer(1)
					case "completed", "COMPLETED":
						o.State = toExportResponseStatePointer(2)
					}
				}
			}
		}
	...
	if val, ok := kv["type"].(*ExportResponseType); ok {
		o.Type = val
	} else if val, ok := kv["type"].(ExportResponseType); ok {
		o.Type = &val
	} else {
		if val, ok := kv["type"]; ok {
			if val == nil {
				o.Type = toExportResponseTypePointer(0)
			} else {
				// if coming in as map, convert it back
				if kv, ok := val.(map[string]interface{}); ok {
					val = kv["ExportResponseType"]
				}
				// this is an enum pointer
				if em, ok := val.(string); ok {
					switch em {
					case "enroll", "ENROLL":
						o.Type = toExportResponseTypePointer(0)
					case "ping", "PING":
						o.Type = toExportResponseTypePointer(1)
					case "crash", "CRASH":
						o.Type = toExportResponseTypePointer(2)
					case "log", "LOG":
						o.Type = toExportResponseTypePointer(3)
					case "integration", "INTEGRATION":
						o.Type = toExportResponseTypePointer(4)
					case "export", "EXPORT":
						o.Type = toExportResponseTypePointer(5)
					case "project", "PROJECT":
						o.Type = toExportResponseTypePointer(6)
					case "repo", "REPO":
						o.Type = toExportResponseTypePointer(7)
					case "user", "USER":
						o.Type = toExportResponseTypePointer(8)
					case "calendar", "CALENDAR":
						o.Type = toExportResponseTypePointer(9)
					case "uninstall", "UNINSTALL":
						o.Type = toExportResponseTypePointer(10)
					case "upgrade", "UPGRADE":
						o.Type = toExportResponseTypePointer(11)
					case "start", "START":
						o.Type = toExportResponseTypePointer(12)
					case "stop", "STOP":
						o.Type = toExportResponseTypePointer(13)
					case "pause", "PAUSE":
						o.Type = toExportResponseTypePointer(14)
					case "resume", "RESUME":
						o.Type = toExportResponseTypePointer(15)
					}
				}
			}
		}
	...
	if val, ok := kv["upload_part_count"].(*int64); ok {
		o.UploadPartCount = val
	} else if val, ok := kv["upload_part_count"].(int64); ok {
		o.UploadPartCount = &val
	} else {
		if val, ok := kv["upload_part_count"]; ok {
			if val == nil {
				o.UploadPartCount = nil
			} else {
				// if coming in as map, convert it back
				if kv, ok := val.(map[string]interface{}); ok {
					val = kv["long"]
				}
				o.UploadPartCount = number.Int64Pointer(number.ToInt64Any(val))
			}
		}
	}
	if val, ok := kv["upload_url"].(*string); ok {
