...
func GetUserResponseAvroSchemaSpec() string {
	spec := map[string]interface{}{
		...
		"fields": []map[string]interface{}{
			...
			map[string]interface{}{
				"name": "users",
				"type": map[string]interface{}{"type": "array", "name": "users", "items": map[string]interface{}{"type": "record", "name": "users", "fields": []interface{}{map[string]interface{}{"doc": "if user is active", "type": "boolean", "name": "active"}, map[string]interface{}{"doc": "the url to users avatar", "type": "string", "name": "avatar_url"}, map[string]interface{}{"type": map[string]interface{}{"type": "array", "name": "emails", "items": "string"}, "name": "emails", "doc": "the email for the user"}, map[string]interface{}{"type": map[string]interface{}{"items": map[string]interface{}{"type": "record", "name": "groups", "fields": []interface{}{map[string]interface{}{"doc": "Group id", "type": "string", "name": "group_id"}, map[string]interface{}{"doc": "Group name", "type": "string", "name": "name"}}, "doc": "Group names"}, "type": "array", "name": "groups"}, "name": "groups", "doc": "Group names"}, map[string]interface{}{"type": "string", "name": "name", "doc": "the name of the user"}, map[string]interface{}{"type": "string", "name": "username", "doc": "the username of the user"}}, "doc": "the exported users"}},
			},
			map[string]interface{}{
				"name": "uuid",
				"type": "string",
