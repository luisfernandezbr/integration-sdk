...
// toCancelRequestCommandPointer is the enumeration pointer type for command
func toCancelRequestCommandPointer(v int32) *CancelRequestCommand {
	nv := CancelRequestCommand(v)
	return &nv
}

// toCancelRequestCommandEnum is the enumeration pointer wrapper for command
func toCancelRequestCommandEnum(v *CancelRequestCommand) string {
	if v == nil {
		return toCancelRequestCommandPointer(0).String()
	}
	return v.String()
}
...
func (o *CancelRequest) SetIntegrationInstanceID(id string) {
	if id == "" {
...
func (o *CancelRequest) GetIntegrationInstanceID() *string {
...
func (o *CancelRequestPartial) ToMap() map[string]interface{} {
	kv := map[string]interface{}{
		...
		"command":      toCancelRequestCommandEnum(o.Command),
	...
	for k, v := range kv {
		if v == nil || reflect.ValueOf(v).IsZero() {
			...
			if k == "request_date" {
				if dt, ok := v.(*CancelRequestRequestDate); ok {
...
// MarshalJSON returns the bytes for marshaling to json
func (o *CancelRequestPartial) MarshalJSON() ([]byte, error) {
	return json.Marshal(o.ToMap())
}

// UnmarshalJSON will unmarshal the json buffer into the object
func (o *CancelRequestPartial) UnmarshalJSON(data []byte) error {
	kv := make(map[string]interface{})
	if err := json.Unmarshal(data, &kv); err != nil {
		return err
	}
...
func (o *CancelRequestPartial) setDefaults(frommap bool) {
}

// FromMap attempts to load data into object from a map
func (o *CancelRequestPartial) FromMap(kv map[string]interface{}) {
	if val, ok := kv["command"].(*CancelRequestCommand); ok {
		o.Command = val
	} else if val, ok := kv["command"].(CancelRequestCommand); ok {
		o.Command = &val
	} else {
		if val, ok := kv["command"]; ok {
			if val == nil {
				o.Command = toCancelRequestCommandPointer(0)
			} else {
				// if coming in as map, convert it back
				if kv, ok := val.(map[string]interface{}); ok {
					val = kv["CancelRequestCommand"]
				}
				...
				if em, ok := val.(string); ok {
					...
					case "export", "EXPORT":
						o.Command = toCancelRequestCommandPointer(0)
					case "onboard", "ONBOARD":
						o.Command = toCancelRequestCommandPointer(1)
					case "integration", "INTEGRATION":
						o.Command = toCancelRequestCommandPointer(2)
					}
				}
			}
		}
	...
	if o.RequestDate == nil {
		o.RequestDate = &CancelRequestRequestDate{}
	}
