...
const (
	...
	// MutationResponseModelSessionIDColumn is the column json value session_id
	MutationResponseModelSessionIDColumn = "session_id"
...
func (o *MutationResponse) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"session_id":              toMutationResponseObject(o.SessionID, false),
...
func (o *MutationResponsePartial) ToMap() map[string]interface{} {
	kv := map[string]interface{}{
		...
		"error":      toMutationResponseObject(o.Error, true),
		"properties": toMutationResponseObject(o.Properties, true),
		"session_id": toMutationResponseObject(o.SessionID, true),
