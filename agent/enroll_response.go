...
func toEnrollResponseEventDateObject(o interface{}, isavro bool, isoptional bool, avrotype string) interface{} {
	...
	// nested => true prefix => EnrollResponseEventDate name => EnrollResponseEventDate
	switch v := o.(type) {
...
func toEnrollResponseObject(o interface{}, isavro bool, isoptional bool, avrotype string) interface{} {
	...
	// nested => false prefix => EnrollResponse name => EnrollResponse
	switch v := o.(type) {
	case *EnrollResponse:
		return v.ToMap(isavro)
...
func GetEnrollResponseAvroSchemaSpec() string {
	spec := map[string]interface{}{
		...
		"fields": []map[string]interface{}{
			...
			map[string]interface{}{
				"name": "event_date",
				"type": map[string]interface{}{"fields": []interface{}{map[string]interface{}{"type": "long", "name": "epoch", "doc": "the date in epoch format"}, map[string]interface{}{"name": "offset", "doc": "the timezone offset from GMT", "type": "long"}, map[string]interface{}{"name": "rfc3339", "doc": "the date in RFC3339 format", "type": "string"}}, "doc": "the date of the event", "type": "record", "name": "event_date"},
			},
			map[string]interface{}{
				"name": "free_space",
				"type": "long",
