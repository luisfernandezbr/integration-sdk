...
const (
	...
	// EnrollResponseModelIntegrationInstanceIDColumn is the column json value integration_instance_id
	EnrollResponseModelIntegrationInstanceIDColumn = "integration_instance_id"
...
// toEnrollResponseTypePointer is the enumeration pointer type for type
func toEnrollResponseTypePointer(v int32) *EnrollResponseType {
	nv := EnrollResponseType(v)
	return &nv
}

// toEnrollResponseTypeEnum is the enumeration pointer wrapper for type
func toEnrollResponseTypeEnum(v *EnrollResponseType) string {
	if v == nil {
		return toEnrollResponseTypePointer(0).String()
	}
	return v.String()
}
...
func (o *EnrollResponse) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"integration_instance_id": toEnrollResponseObject(o.IntegrationInstanceID, true),
...
func (o *EnrollResponsePartial) ToMap() map[string]interface{} {
	kv := map[string]interface{}{
		...
		"type":    toEnrollResponseTypeEnum(o.Type),
	...
	for k, v := range kv {
		if v == nil || reflect.ValueOf(v).IsZero() {
			...
			if k == "event_date" {
				if dt, ok := v.(*EnrollResponseEventDate); ok {
			...
			if k == "last_export_date" {
				if dt, ok := v.(*EnrollResponseLastExportDate); ok {
					if dt.Epoch == 0 && dt.Offset == 0 && dt.Rfc3339 == "" {
						delete(kv, k)
					}
				}
...
// MarshalJSON returns the bytes for marshaling to json
func (o *EnrollResponsePartial) MarshalJSON() ([]byte, error) {
	return json.Marshal(o.ToMap())
}

// UnmarshalJSON will unmarshal the json buffer into the object
func (o *EnrollResponsePartial) UnmarshalJSON(data []byte) error {
	kv := make(map[string]interface{})
	if err := json.Unmarshal(data, &kv); err != nil {
		return err
	}
...
func (o *EnrollResponsePartial) setDefaults(frommap bool) {
}

// FromMap attempts to load data into object from a map
func (o *EnrollResponsePartial) FromMap(kv map[string]interface{}) {
	if val, ok := kv["apikey"].(*string); ok {
		o.Apikey = val
	} else if val, ok := kv["apikey"].(string); ok {
		o.Apikey = &val
	} else {
		if val, ok := kv["apikey"]; ok {
			if val == nil {
	...
	if o.LastExportDate == nil {
		o.LastExportDate = &EnrollResponseLastExportDate{}
	}
	...
	if val, ok := kv["type"].(*EnrollResponseType); ok {
		o.Type = val
	} else if val, ok := kv["type"].(EnrollResponseType); ok {
		o.Type = &val
	} else {
		if val, ok := kv["type"]; ok {
			if val == nil {
				o.Type = toEnrollResponseTypePointer(0)
			} else {
				// if coming in as map, convert it back
				if kv, ok := val.(map[string]interface{}); ok {
					val = kv["EnrollResponseType"]
				}
				...
				if em, ok := val.(string); ok {
					...
					case "enroll", "ENROLL":
						o.Type = toEnrollResponseTypePointer(0)
					case "ping", "PING":
						o.Type = toEnrollResponseTypePointer(1)
					case "crash", "CRASH":
						o.Type = toEnrollResponseTypePointer(2)
					case "log", "LOG":
						o.Type = toEnrollResponseTypePointer(3)
					case "integration", "INTEGRATION":
						o.Type = toEnrollResponseTypePointer(4)
					case "export", "EXPORT":
						o.Type = toEnrollResponseTypePointer(5)
					case "project", "PROJECT":
						o.Type = toEnrollResponseTypePointer(6)
					case "repo", "REPO":
						o.Type = toEnrollResponseTypePointer(7)
					case "user", "USER":
						o.Type = toEnrollResponseTypePointer(8)
					case "calendar", "CALENDAR":
						o.Type = toEnrollResponseTypePointer(9)
					case "uninstall", "UNINSTALL":
						o.Type = toEnrollResponseTypePointer(10)
					case "upgrade", "UPGRADE":
						o.Type = toEnrollResponseTypePointer(11)
					case "start", "START":
						o.Type = toEnrollResponseTypePointer(12)
					case "stop", "STOP":
						o.Type = toEnrollResponseTypePointer(13)
					case "pause", "PAUSE":
						o.Type = toEnrollResponseTypePointer(14)
					case "resume", "RESUME":
						o.Type = toEnrollResponseTypePointer(15)
					}
				}
			}
		}
