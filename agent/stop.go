...
type Stop struct {
	...
	EventDate StopEventDate `json:"event_date" yaml:"event_date" faker:"-"`
	...
	LastExportDate StopLastExportDate `json:"last_export_date" yaml:"last_export_date" faker:"-"`
	...
	Type StopType `json:"type" yaml:"type" faker:"-"`
