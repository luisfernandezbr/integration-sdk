...
const (
	...
	// ProjectTriggerRequestDateColumn is the request_date column name
	ProjectTriggerRequestDateColumn = "request_date"
	// ProjectTriggerRequestDateColumnEpochColumn is the epoch column property of the RequestDate name
	ProjectTriggerRequestDateColumnEpochColumn = "request_date->epoch"
	// ProjectTriggerRequestDateColumnOffsetColumn is the offset column property of the RequestDate name
	ProjectTriggerRequestDateColumnOffsetColumn = "request_date->offset"
	// ProjectTriggerRequestDateColumnRfc3339Column is the rfc3339 column property of the RequestDate name
	ProjectTriggerRequestDateColumnRfc3339Column = "request_date->rfc3339"
	// ProjectTriggerUpdatedAtColumn is the updated_ts column name
	ProjectTriggerUpdatedAtColumn = "updated_ts"
)

// ProjectTriggerRequestDate represents the object structure for request_date
type ProjectTriggerRequestDate struct {
...
func toProjectTriggerRequestDateObjectNil(isavro bool, isoptional bool) interface{} {
...
func toProjectTriggerRequestDateObject(o interface{}, isavro bool, isoptional bool, avrotype string) interface{} {
	if res, ok := datamodel.ToGolangObject(o, isavro, isoptional, avrotype); ok {
		return res
	}
	switch v := o.(type) {
	case *ProjectTriggerRequestDate:
...
func (o *ProjectTriggerRequestDate) ToMap(avro ...bool) map[string]interface{} {
	var isavro bool
	...
	return map[string]interface{}{
		// Epoch the date in epoch format
		"epoch": toProjectTriggerRequestDateObject(o.Epoch, isavro, false, "long"),
		// Offset the timezone offset from GMT
		"offset": toProjectTriggerRequestDateObject(o.Offset, isavro, false, "long"),
		// Rfc3339 the date in RFC3339 format
		"rfc3339": toProjectTriggerRequestDateObject(o.Rfc3339, isavro, false, "string"),
	}
}

func (o *ProjectTriggerRequestDate) setDefaults(frommap bool) {
...
type ProjectTrigger struct {
	...
	RequestDate ProjectTriggerRequestDate `json:"request_date" bson:"request_date" yaml:"request_date" faker:"-"`
...
func (o *ProjectTrigger) ToMap(avro ...bool) map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"request_date":   toProjectTriggerObject(o.RequestDate, isavro, false, "request_date"),
...
func (o *ProjectTrigger) FromMap(kv map[string]interface{}) {
	...
	if val, ok := kv["request_date"]; ok {
		...
		} else if sv, ok := val.(ProjectTriggerRequestDate); ok {
			// struct
			o.RequestDate = sv
		} else if sp, ok := val.(*ProjectTriggerRequestDate); ok {
			// struct pointer
			o.RequestDate = *sp
