...
type Ping struct {
	...
	EventDate PingEventDate `json:"event_date" yaml:"event_date" faker:"-"`
	...
	LastExportDate PingLastExportDate `json:"last_export_date" yaml:"last_export_date" faker:"-"`
