...
type CodequalityResponse struct {
	...
	EventDate CodequalityResponseEventDate `json:"event_date" yaml:"event_date" faker:"-"`
	...
	LastExportDate CodequalityResponseLastExportDate `json:"last_export_date" yaml:"last_export_date" faker:"-"`
	...
	Projects []CodequalityResponseProjects `json:"projects" yaml:"projects" faker:"-"`
	// RefID the source system id for the model instance
	RefID string `json:"ref_id" yaml:"ref_id" faker:"-"`
	// RefType the source system identifier for the model instance
	RefType string `json:"ref_type" yaml:"ref_type" faker:"-"`
	...
	Type CodequalityResponseType `json:"type" yaml:"type" faker:"-"`
