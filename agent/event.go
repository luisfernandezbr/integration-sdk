...
type Event struct {
	...
	EventDate EventEventDate `json:"event_date" yaml:"event_date" faker:"-"`
	...
	LastExportDate EventLastExportDate `json:"last_export_date" yaml:"last_export_date" faker:"-"`
	...
	Type EventType `json:"type" yaml:"type" faker:"-"`
