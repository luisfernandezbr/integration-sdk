...
func (o *RepoTrigger) SetIntegrationInstanceID(id string) {
	if id == "" {
...
func (o *RepoTrigger) GetIntegrationInstanceID() *string {
...
// MarshalJSON returns the bytes for marshaling to json
func (o *RepoTriggerPartial) MarshalJSON() ([]byte, error) {
	return json.Marshal(o.ToMap())
}

// UnmarshalJSON will unmarshal the json buffer into the object
func (o *RepoTriggerPartial) UnmarshalJSON(data []byte) error {
	kv := make(map[string]interface{})
	if err := json.Unmarshal(data, &kv); err != nil {
		return err
	}
...
func (o *RepoTriggerPartial) setDefaults(frommap bool) {
}

// FromMap attempts to load data into object from a map
func (o *RepoTriggerPartial) FromMap(kv map[string]interface{}) {
	if val, ok := kv["integration_id"].(*string); ok {
		o.IntegrationID = val
