...
const (
	...
	// IntegrationRequestModelIntegrationConfigColumn is the column json value config
	IntegrationRequestModelIntegrationConfigColumn = "config"
	...
	// IntegrationRequestModelIntegrationIntegrationInstanceIDColumn is the column json value integration_instance_id
	IntegrationRequestModelIntegrationIntegrationInstanceIDColumn = "integration_instance_id"
	// IntegrationRequestModelIntegrationIntervalColumn is the column json value interval
	IntegrationRequestModelIntegrationIntervalColumn = "interval"
	...
	// IntegrationRequestModelIntegrationPausedColumn is the column json value paused
	IntegrationRequestModelIntegrationPausedColumn = "paused"
	...
	// IntegrationRequestModelIntegrationInstanceIDColumn is the column json value integration_instance_id
	IntegrationRequestModelIntegrationInstanceIDColumn = "integration_instance_id"
...
// toIntegrationRequestIntegrationLocationPointer is the enumeration pointer type for location
func toIntegrationRequestIntegrationLocationPointer(v int32) *IntegrationRequestIntegrationLocation {
	nv := IntegrationRequestIntegrationLocation(v)
	return &nv
}

// toIntegrationRequestIntegrationLocationEnum is the enumeration pointer wrapper for location
func toIntegrationRequestIntegrationLocationEnum(v *IntegrationRequestIntegrationLocation) string {
	if v == nil {
		return toIntegrationRequestIntegrationLocationPointer(0).String()
	}
	return v.String()
}
...
// toIntegrationRequestIntegrationStatePointer is the enumeration pointer type for state
func toIntegrationRequestIntegrationStatePointer(v int32) *IntegrationRequestIntegrationState {
	nv := IntegrationRequestIntegrationState(v)
	return &nv
}

// toIntegrationRequestIntegrationStateEnum is the enumeration pointer wrapper for state
func toIntegrationRequestIntegrationStateEnum(v *IntegrationRequestIntegrationState) string {
	if v == nil {
		return toIntegrationRequestIntegrationStatePointer(0).String()
	}
	return v.String()
}
...
// toIntegrationRequestIntegrationSystemTypePointer is the enumeration pointer type for system_type
func toIntegrationRequestIntegrationSystemTypePointer(v int32) *IntegrationRequestIntegrationSystemType {
	nv := IntegrationRequestIntegrationSystemType(v)
	return &nv
}

// toIntegrationRequestIntegrationSystemTypeEnum is the enumeration pointer wrapper for system_type
func toIntegrationRequestIntegrationSystemTypeEnum(v *IntegrationRequestIntegrationSystemType) string {
	if v == nil {
		return toIntegrationRequestIntegrationSystemTypePointer(0).String()
	}
	return v.String()
}
...
func (o *IntegrationRequestIntegration) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		// Config the integration configuration controlled by the integration itself
		"config": toIntegrationRequestIntegrationObject(o.Config, true),
		// CreatedByProfileID The id of the profile for the user that created the integration
		...
		// IntegrationInstanceID the integration instance id
		"integration_instance_id": toIntegrationRequestIntegrationObject(o.IntegrationInstanceID, true),
		// Interval the interval in milliseconds for how often an export job is scheduled
		"interval": toIntegrationRequestIntegrationObject(o.Interval, false),
		// LastExportCompletedDate when the export response was received (set by the backend)
		...
		// Paused true if the agent is paused and should not start new scheduled jobs
		"paused": toIntegrationRequestIntegrationObject(o.Paused, false),
		// Processed If the integration has been processed at least once
...
func (o *IntegrationRequest) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"integration_instance_id": toIntegrationRequestObject(o.IntegrationInstanceID, true),
...
func (o *IntegrationRequest) SetIntegrationInstanceID(id string) {
	if id == "" {
...
func (o *IntegrationRequest) GetIntegrationInstanceID() *string {
...
func (o *IntegrationRequestPartial) ToMap() map[string]interface{} {
	...
	for k, v := range kv {
		if v == nil || reflect.ValueOf(v).IsZero() {
			...
			if k == "request_date" {
				if dt, ok := v.(*IntegrationRequestRequestDate); ok {
...
// MarshalJSON returns the bytes for marshaling to json
func (o *IntegrationRequestPartial) MarshalJSON() ([]byte, error) {
	return json.Marshal(o.ToMap())
}

// UnmarshalJSON will unmarshal the json buffer into the object
func (o *IntegrationRequestPartial) UnmarshalJSON(data []byte) error {
	kv := make(map[string]interface{})
	if err := json.Unmarshal(data, &kv); err != nil {
		return err
	}
...
func (o *IntegrationRequestPartial) setDefaults(frommap bool) {
}

// FromMap attempts to load data into object from a map
func (o *IntegrationRequestPartial) FromMap(kv map[string]interface{}) {
