...
func (o *IntegrationRequestIntegrationAuthorization) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		// Collection Collection for instance, if relevant
		"collection": toIntegrationRequestIntegrationAuthorizationObject(o.Collection, true),
		// APIKey API Key for instance, if relevant
...
type IntegrationRequestIntegration struct {
	...
	Authorization IntegrationRequestIntegrationAuthorization `json:"authorization" yaml:"authorization" faker:"-"`
	...
	Location IntegrationRequestIntegrationLocation `json:"location" yaml:"location" faker:"-"`
	// Name The user friendly name of the integration
	Name string `json:"name" yaml:"name" faker:"-"`
	// Progress Agent processing progress
	Progress IntegrationRequestIntegrationProgress `json:"progress" yaml:"progress" faker:"-"`
	// RefID the source system id for the model instance
	RefID string `json:"ref_id" yaml:"ref_id" faker:"-"`
	// RefType the source system identifier for the model instance
	RefType string `json:"ref_type" yaml:"ref_type" faker:"-"`
	// SystemType The system type of the integration (sourcecode / work (jira) / codequality / etc.)
	SystemType IntegrationRequestIntegrationSystemType `json:"system_type" yaml:"system_type" faker:"-"`
	...
	ValidatedDate IntegrationRequestIntegrationValidatedDate `json:"validated_date" yaml:"validated_date" faker:"-"`
...
type IntegrationRequest struct {
	...
	Integration IntegrationRequestIntegration `json:"integration" yaml:"integration" faker:"-"`
	// RefID the source system id for the model instance
	RefID string `json:"ref_id" yaml:"ref_id" faker:"-"`
	// RefType the source system identifier for the model instance
	RefType string `json:"ref_type" yaml:"ref_type" faker:"-"`
	// RequestDate the date when the request was made
	RequestDate IntegrationRequestRequestDate `json:"request_date" yaml:"request_date" faker:"-"`
