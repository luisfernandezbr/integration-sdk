...
const (
	...
	// RestartTriggerModelIntegrationInstanceIDColumn is the column json value integration_instance_id
	RestartTriggerModelIntegrationInstanceIDColumn = "integration_instance_id"
...
func (o *RestartTrigger) SetEventHeaders(kv map[string]string) {
	kv["customer_id"] = o.CustomerID
	kv["model"] = RestartTriggerModelName.String()
}
...
func (o *RestartTrigger) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"integration_instance_id": toRestartTriggerObject(o.IntegrationInstanceID, true),
...
var _ datamodel.PartialModel = (*RestartTriggerPartial)(nil)

// GetModelName returns the name of the model
func (o *RestartTriggerPartial) GetModelName() datamodel.ModelNameType {
	return RestartTriggerModelName
}

// ToMap returns the object as a map
func (o *RestartTriggerPartial) ToMap() map[string]interface{} {
	kv := map[string]interface{}{
		"uuid": toRestartTriggerObject(o.UUID, true),
	}
	for k, v := range kv {
...
// Stringify returns the object in JSON format as a string
func (o *RestartTriggerPartial) Stringify() string {
	return pjson.Stringify(o.ToMap())
}

// MarshalJSON returns the bytes for marshaling to json
func (o *RestartTriggerPartial) MarshalJSON() ([]byte, error) {
	return json.Marshal(o.ToMap())
}

// UnmarshalJSON will unmarshal the json buffer into the object
func (o *RestartTriggerPartial) UnmarshalJSON(data []byte) error {
	kv := make(map[string]interface{})
	if err := json.Unmarshal(data, &kv); err != nil {
		return err
	}
...
func (o *RestartTriggerPartial) setDefaults(frommap bool) {
}

// FromMap attempts to load data into object from a map
func (o *RestartTriggerPartial) FromMap(kv map[string]interface{}) {
	if val, ok := kv["uuid"].(*string); ok {
		o.UUID = val
