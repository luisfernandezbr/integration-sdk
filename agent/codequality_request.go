...
const (
	...
	// CodequalityRequestModelIntegrationConfigColumn is the column json value config
	CodequalityRequestModelIntegrationConfigColumn = "config"
	...
	// CodequalityRequestModelIntegrationIntegrationInstanceIDColumn is the column json value integration_instance_id
	CodequalityRequestModelIntegrationIntegrationInstanceIDColumn = "integration_instance_id"
	// CodequalityRequestModelIntegrationIntervalColumn is the column json value interval
	CodequalityRequestModelIntegrationIntervalColumn = "interval"
	...
	// CodequalityRequestModelIntegrationPausedColumn is the column json value paused
	CodequalityRequestModelIntegrationPausedColumn = "paused"
	...
	// CodequalityRequestModelIntegrationInstanceIDColumn is the column json value integration_instance_id
	CodequalityRequestModelIntegrationInstanceIDColumn = "integration_instance_id"
...
// toCodequalityRequestIntegrationLocationPointer is the enumeration pointer type for location
func toCodequalityRequestIntegrationLocationPointer(v int32) *CodequalityRequestIntegrationLocation {
	nv := CodequalityRequestIntegrationLocation(v)
	return &nv
}

// toCodequalityRequestIntegrationLocationEnum is the enumeration pointer wrapper for location
func toCodequalityRequestIntegrationLocationEnum(v *CodequalityRequestIntegrationLocation) string {
	if v == nil {
		return toCodequalityRequestIntegrationLocationPointer(0).String()
	}
	return v.String()
}
...
// toCodequalityRequestIntegrationStatePointer is the enumeration pointer type for state
func toCodequalityRequestIntegrationStatePointer(v int32) *CodequalityRequestIntegrationState {
	nv := CodequalityRequestIntegrationState(v)
	return &nv
}

// toCodequalityRequestIntegrationStateEnum is the enumeration pointer wrapper for state
func toCodequalityRequestIntegrationStateEnum(v *CodequalityRequestIntegrationState) string {
	if v == nil {
		return toCodequalityRequestIntegrationStatePointer(0).String()
	}
	return v.String()
}
...
// toCodequalityRequestIntegrationSystemTypePointer is the enumeration pointer type for system_type
func toCodequalityRequestIntegrationSystemTypePointer(v int32) *CodequalityRequestIntegrationSystemType {
	nv := CodequalityRequestIntegrationSystemType(v)
	return &nv
}

// toCodequalityRequestIntegrationSystemTypeEnum is the enumeration pointer wrapper for system_type
func toCodequalityRequestIntegrationSystemTypeEnum(v *CodequalityRequestIntegrationSystemType) string {
	if v == nil {
		return toCodequalityRequestIntegrationSystemTypePointer(0).String()
	}
	return v.String()
}
...
func (o *CodequalityRequestIntegration) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		// Config the integration configuration controlled by the integration itself
		"config": toCodequalityRequestIntegrationObject(o.Config, true),
		// CreatedByProfileID The id of the profile for the user that created the integration
		...
		// IntegrationInstanceID the integration instance id
		"integration_instance_id": toCodequalityRequestIntegrationObject(o.IntegrationInstanceID, true),
		// Interval the interval in milliseconds for how often an export job is scheduled
		"interval": toCodequalityRequestIntegrationObject(o.Interval, false),
		// LastExportCompletedDate when the export response was received (set by the backend)
		...
		// Paused true if the agent is paused and should not start new scheduled jobs
		"paused": toCodequalityRequestIntegrationObject(o.Paused, false),
		// Processed If the integration has been processed at least once
...
func (o *CodequalityRequest) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"integration_instance_id": toCodequalityRequestObject(o.IntegrationInstanceID, true),
...
func (o *CodequalityRequest) SetIntegrationInstanceID(id string) {
	if id == "" {
...
func (o *CodequalityRequest) GetIntegrationInstanceID() *string {
...
func (o *CodequalityRequestPartial) ToMap() map[string]interface{} {
	...
	for k, v := range kv {
		if v == nil || reflect.ValueOf(v).IsZero() {
			...
			if k == "request_date" {
				if dt, ok := v.(*CodequalityRequestRequestDate); ok {
...
// MarshalJSON returns the bytes for marshaling to json
func (o *CodequalityRequestPartial) MarshalJSON() ([]byte, error) {
	return json.Marshal(o.ToMap())
}

// UnmarshalJSON will unmarshal the json buffer into the object
func (o *CodequalityRequestPartial) UnmarshalJSON(data []byte) error {
	kv := make(map[string]interface{})
	if err := json.Unmarshal(data, &kv); err != nil {
		return err
	}
...
func (o *CodequalityRequestPartial) setDefaults(frommap bool) {
}

// FromMap attempts to load data into object from a map
func (o *CodequalityRequestPartial) FromMap(kv map[string]interface{}) {

	if o.Integration == nil {
		o.Integration = &CodequalityRequestIntegration{}
	}
	...
	if o.RequestDate == nil {
		o.RequestDate = &CodequalityRequestRequestDate{}
	}
