...
const (
	...
	EnabledCustomerIDColumn = "CustomerID"
...
type Enabled struct {
	...
	EventDate EnabledEventDate `json:"event_date" yaml:"event_date" faker:"-"`
	...
	LastExportDate EnabledLastExportDate `json:"last_export_date" yaml:"last_export_date" faker:"-"`
	...
	Type EnabledType `json:"type" yaml:"type" faker:"-"`
