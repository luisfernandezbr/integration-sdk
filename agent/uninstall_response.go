...
const (
	...
	// UninstallResponseModelIntegrationInstanceIDColumn is the column json value integration_instance_id
	UninstallResponseModelIntegrationInstanceIDColumn = "integration_instance_id"
...
// toUninstallResponseTypePointer is the enumeration pointer type for type
func toUninstallResponseTypePointer(v int32) *UninstallResponseType {
	nv := UninstallResponseType(v)
	return &nv
}

// toUninstallResponseTypeEnum is the enumeration pointer wrapper for type
func toUninstallResponseTypeEnum(v *UninstallResponseType) string {
	if v == nil {
		return toUninstallResponseTypePointer(0).String()
	}
	return v.String()
}
...
const (
	...
	// UninstallResponseTypeCalendar is the enumeration value for calendar
	UninstallResponseTypeCalendar UninstallResponseType = 9
	// UninstallResponseTypeUninstall is the enumeration value for uninstall
	UninstallResponseTypeUninstall UninstallResponseType = 10
	// UninstallResponseTypeUpgrade is the enumeration value for upgrade
	UninstallResponseTypeUpgrade UninstallResponseType = 11
	// UninstallResponseTypeStart is the enumeration value for start
	UninstallResponseTypeStart UninstallResponseType = 12
	// UninstallResponseTypeStop is the enumeration value for stop
	UninstallResponseTypeStop UninstallResponseType = 13
	// UninstallResponseTypePause is the enumeration value for pause
	UninstallResponseTypePause UninstallResponseType = 14
	// UninstallResponseTypeResume is the enumeration value for resume
	UninstallResponseTypeResume UninstallResponseType = 15
)
...
func (o *UninstallResponse) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"integration_instance_id": toUninstallResponseObject(o.IntegrationInstanceID, true),
...
type UninstallResponsePartial struct {
	...
	// EventDate the date of the event
	EventDate *UninstallResponseEventDate `json:"event_date,omitempty"`
	// FreeSpace the amount of free space in bytes for the agent machine
	...
	// LastExportDate the last export date
	LastExportDate *UninstallResponseLastExportDate `json:"last_export_date,omitempty"`
	// Memory the amount of memory in bytes for the agent machine
	...
	// Type the type of event
	Type *UninstallResponseType `json:"type,omitempty"`
	// Uptime the uptime in milliseconds since the agent started
...
var _ datamodel.PartialModel = (*UninstallResponsePartial)(nil)

// GetModelName returns the name of the model
func (o *UninstallResponsePartial) GetModelName() datamodel.ModelNameType {
	return UninstallResponseModelName
}

// ToMap returns the object as a map
func (o *UninstallResponsePartial) ToMap() map[string]interface{} {
	kv := map[string]interface{}{
		"architecture":     toUninstallResponseObject(o.Architecture, true),
		"data":             toUninstallResponseObject(o.Data, true),
		"distro":           toUninstallResponseObject(o.Distro, true),
		"error":            toUninstallResponseObject(o.Error, true),
		"event_date":       toUninstallResponseObject(o.EventDate, true),
		"free_space":       toUninstallResponseObject(o.FreeSpace, true),
		"go_version":       toUninstallResponseObject(o.GoVersion, true),
		"hostname":         toUninstallResponseObject(o.Hostname, true),
		"last_export_date": toUninstallResponseObject(o.LastExportDate, true),
		"memory":           toUninstallResponseObject(o.Memory, true),
		"message":          toUninstallResponseObject(o.Message, true),
		"num_cpu":          toUninstallResponseObject(o.NumCPU, true),
		"os":               toUninstallResponseObject(o.OS, true),
		"request_id":       toUninstallResponseObject(o.RequestID, true),
		"success":          toUninstallResponseObject(o.Success, true),
		"system_id":        toUninstallResponseObject(o.SystemID, true),

		"type":    toUninstallResponseTypeEnum(o.Type),
		"uptime":  toUninstallResponseObject(o.Uptime, true),
		"uuid":    toUninstallResponseObject(o.UUID, true),
		"version": toUninstallResponseObject(o.Version, true),
	}
	for k, v := range kv {
		if v == nil || reflect.ValueOf(v).IsZero() {
			...
			if k == "event_date" {
				if dt, ok := v.(*UninstallResponseEventDate); ok {
			...
			if k == "last_export_date" {
				if dt, ok := v.(*UninstallResponseLastExportDate); ok {
					if dt.Epoch == 0 && dt.Offset == 0 && dt.Rfc3339 == "" {
						delete(kv, k)
					}
				}
...
// Stringify returns the object in JSON format as a string
func (o *UninstallResponsePartial) Stringify() string {
	return pjson.Stringify(o.ToMap())
}

// MarshalJSON returns the bytes for marshaling to json
func (o *UninstallResponsePartial) MarshalJSON() ([]byte, error) {
	return json.Marshal(o.ToMap())
}

// UnmarshalJSON will unmarshal the json buffer into the object
func (o *UninstallResponsePartial) UnmarshalJSON(data []byte) error {
	kv := make(map[string]interface{})
	if err := json.Unmarshal(data, &kv); err != nil {
		return err
	}
...
func (o *UninstallResponsePartial) setDefaults(frommap bool) {
}

// FromMap attempts to load data into object from a map
func (o *UninstallResponsePartial) FromMap(kv map[string]interface{}) {
	if val, ok := kv["architecture"].(*string); ok {
		o.Architecture = val
	...
	if o.EventDate == nil {
		o.EventDate = &UninstallResponseEventDate{}
	}
	...
	if o.LastExportDate == nil {
		o.LastExportDate = &UninstallResponseLastExportDate{}
	}
	...
	if val, ok := kv["type"].(*UninstallResponseType); ok {
		o.Type = val
	} else if val, ok := kv["type"].(UninstallResponseType); ok {
		o.Type = &val
	} else {
		if val, ok := kv["type"]; ok {
			if val == nil {
				o.Type = toUninstallResponseTypePointer(0)
			} else {
				// if coming in as map, convert it back
				if kv, ok := val.(map[string]interface{}); ok {
					val = kv["UninstallResponseType"]
				}
				...
				if em, ok := val.(string); ok {
					...
					case "enroll", "ENROLL":
						o.Type = toUninstallResponseTypePointer(0)
					case "ping", "PING":
						o.Type = toUninstallResponseTypePointer(1)
					case "crash", "CRASH":
						o.Type = toUninstallResponseTypePointer(2)
					case "log", "LOG":
						o.Type = toUninstallResponseTypePointer(3)
					case "integration", "INTEGRATION":
						o.Type = toUninstallResponseTypePointer(4)
					case "export", "EXPORT":
						o.Type = toUninstallResponseTypePointer(5)
					case "project", "PROJECT":
						o.Type = toUninstallResponseTypePointer(6)
					case "repo", "REPO":
						o.Type = toUninstallResponseTypePointer(7)
					case "user", "USER":
						o.Type = toUninstallResponseTypePointer(8)
					case "calendar", "CALENDAR":
						o.Type = toUninstallResponseTypePointer(9)
					case "uninstall", "UNINSTALL":
						o.Type = toUninstallResponseTypePointer(10)
					case "upgrade", "UPGRADE":
						o.Type = toUninstallResponseTypePointer(11)
					case "start", "START":
						o.Type = toUninstallResponseTypePointer(12)
					case "stop", "STOP":
						o.Type = toUninstallResponseTypePointer(13)
					case "pause", "PAUSE":
						o.Type = toUninstallResponseTypePointer(14)
					case "resume", "RESUME":
						o.Type = toUninstallResponseTypePointer(15)
					}
				}
			}
		}
