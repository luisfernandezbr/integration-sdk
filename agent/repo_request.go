...
func (o *RepoRequestIntegrationAuthorization) ToMap(avro ...bool) map[string]interface{} {
	...
	return map[string]interface{}{
		...
		// Collection Collection for instance, if relevant
		"collection": toRepoRequestIntegrationAuthorizationObject(o.Collection, isavro, true, "string"),
		// APIKey API Key for instance, if relevant
		"api_key": toRepoRequestIntegrationAuthorizationObject(o.APIKey, isavro, true, "string"),
		// Authorization the agents encrypted authorization
		"authorization": toRepoRequestIntegrationAuthorizationObject(o.Authorization, isavro, true, "string"),
		// Hostname Hostname for instance, if relevant
		"hostname": toRepoRequestIntegrationAuthorizationObject(o.Hostname, isavro, true, "string"),
	}
}
...
func (o *RepoRequest) GetStreamName() string {
	return RepoRequestStream.String()
}
...
func (o *RepoRequest) MarshalBinary() ([]byte, error) {
	return o.MarshalJSON()
}

func (o *RepoRequest) UnmarshalBinary(data []byte) error {
...
var cachedCodecRepoRequestLock sync.Mutex

// GetAvroCodec returns the avro codec for this model
func (o *RepoRequest) GetAvroCodec() *goavro.Codec {
	cachedCodecRepoRequestLock.Lock()
	...
	cachedCodecRepoRequestLock.Unlock()
