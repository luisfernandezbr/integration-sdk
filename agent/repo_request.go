...
// RepoRequestIntegrationLastProcessedDate represents the object structure for last_processed_date
type RepoRequestIntegrationLastProcessedDate struct {
...
func toRepoRequestIntegrationLastProcessedDateObject(o interface{}, isoptional bool) interface{} {
	switch v := o.(type) {
	case *RepoRequestIntegrationLastProcessedDate:
		return v.ToMap()
...
func (o *RepoRequestIntegrationLastProcessedDate) ToMap() map[string]interface{} {
	o.setDefaults(true)
	return map[string]interface{}{
		// Epoch the date in epoch format
		"epoch": toRepoRequestIntegrationLastProcessedDateObject(o.Epoch, false),
		// Offset the timezone offset from GMT
		"offset": toRepoRequestIntegrationLastProcessedDateObject(o.Offset, false),
		// Rfc3339 the date in RFC3339 format
		"rfc3339": toRepoRequestIntegrationLastProcessedDateObject(o.Rfc3339, false),
	}
}

func (o *RepoRequestIntegrationLastProcessedDate) setDefaults(frommap bool) {
...
// FromMap attempts to load data into object from a map
func (o *RepoRequestIntegrationLastProcessedDate) FromMap(kv map[string]interface{}) {
...
type RepoRequestIntegration struct {
	...
	LastProcessedDate RepoRequestIntegrationLastProcessedDate `json:"last_processed_date" codec:"last_processed_date" bson:"last_processed_date" yaml:"last_processed_date" faker:"-"`
...
func (o *RepoRequestIntegration) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		// LastProcessedDate Date when last processed
		"last_processed_date": toRepoRequestIntegrationObject(o.LastProcessedDate, false),
		// Location The location of this integration (on-premise / private or cloud)
...
func (o *RepoRequestIntegration) FromMap(kv map[string]interface{}) {
	...
	if val, ok := kv["last_processed_date"]; ok {
		...
		} else if sv, ok := val.(RepoRequestIntegrationLastProcessedDate); ok {
			// struct
			o.LastProcessedDate = sv
		} else if sp, ok := val.(*RepoRequestIntegrationLastProcessedDate); ok {
			// struct pointer
