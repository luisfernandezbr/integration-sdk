...
func (v WorkStatusRequestIntegrationLocation) UnmarshalBSON(buf []byte) error {
	switch string(buf) {
	case "PRIVATE":
		v = 0
	case "CLOUD":
...
func (v WorkStatusRequestIntegrationLocation) MarshalBSON() ([]byte, error) {
	switch v {
	case 0:
...
// UnmarshalBSON unmarshals the enum value
func (v WorkStatusRequestIntegrationSystemType) UnmarshalBSON(buf []byte) error {
	switch string(buf) {
	case "WORK":
		v = 0
	case "SOURCECODE":
...
// MarshalBSON marshals the enum value
func (v WorkStatusRequestIntegrationSystemType) MarshalBSON() ([]byte, error) {
	switch v {
	case 0:
