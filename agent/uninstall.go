...
type Uninstall struct {
	...
	EventDate UninstallEventDate `json:"event_date" yaml:"event_date" faker:"-"`
	...
	LastExportDate UninstallLastExportDate `json:"last_export_date" yaml:"last_export_date" faker:"-"`
	...
	Type UninstallType `json:"type" yaml:"type" faker:"-"`
