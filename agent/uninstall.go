...
func (o *Uninstall) MarshalBinary() ([]byte, error) {
	return o.MarshalJSON()
}

func (o *Uninstall) UnmarshalBinary(data []byte) error {
...
var cachedCodecUninstallLock sync.Mutex

// GetAvroCodec returns the avro codec for this model
func (o *Uninstall) GetAvroCodec() *goavro.Codec {
	cachedCodecUninstallLock.Lock()
	...
	cachedCodecUninstallLock.Unlock()
