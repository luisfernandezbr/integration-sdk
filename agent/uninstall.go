...
// toUninstallTypePointer is the enumeration pointer type for type
func toUninstallTypePointer(v int32) *UninstallType {
	nv := UninstallType(v)
	return &nv
}

// toUninstallTypeEnum is the enumeration pointer wrapper for type
func toUninstallTypeEnum(v *UninstallType) string {
	if v == nil {
		return toUninstallTypePointer(0).String()
	}
	return v.String()
}
...
func (o *Uninstall) SetIntegrationInstanceID(id string) {
	if id == "" {
...
func (o *Uninstall) GetIntegrationInstanceID() *string {
...
func (o *UninstallPartial) ToMap() map[string]interface{} {
	kv := map[string]interface{}{
		...
		"type":    toUninstallTypeEnum(o.Type),
	...
	for k, v := range kv {
		if v == nil || reflect.ValueOf(v).IsZero() {
			...
			if k == "event_date" {
				if dt, ok := v.(*UninstallEventDate); ok {
			...
			if k == "last_export_date" {
				if dt, ok := v.(*UninstallLastExportDate); ok {
					if dt.Epoch == 0 && dt.Offset == 0 && dt.Rfc3339 == "" {
						delete(kv, k)
					}
				}
...
// MarshalJSON returns the bytes for marshaling to json
func (o *UninstallPartial) MarshalJSON() ([]byte, error) {
	return json.Marshal(o.ToMap())
}

// UnmarshalJSON will unmarshal the json buffer into the object
func (o *UninstallPartial) UnmarshalJSON(data []byte) error {
	kv := make(map[string]interface{})
	if err := json.Unmarshal(data, &kv); err != nil {
		return err
	}
...
func (o *UninstallPartial) setDefaults(frommap bool) {
}

// FromMap attempts to load data into object from a map
func (o *UninstallPartial) FromMap(kv map[string]interface{}) {
	if val, ok := kv["architecture"].(*string); ok {
		o.Architecture = val
	...
	if o.EventDate == nil {
		o.EventDate = &UninstallEventDate{}
	}
	...
	if o.LastExportDate == nil {
		o.LastExportDate = &UninstallLastExportDate{}
	}
	...
	if val, ok := kv["type"].(*UninstallType); ok {
		o.Type = val
	} else if val, ok := kv["type"].(UninstallType); ok {
		o.Type = &val
	} else {
		if val, ok := kv["type"]; ok {
			if val == nil {
				o.Type = toUninstallTypePointer(0)
			} else {
				// if coming in as map, convert it back
				if kv, ok := val.(map[string]interface{}); ok {
					val = kv["UninstallType"]
				}
				...
				if em, ok := val.(string); ok {
					...
					case "enroll", "ENROLL":
						o.Type = toUninstallTypePointer(0)
					case "ping", "PING":
						o.Type = toUninstallTypePointer(1)
					case "crash", "CRASH":
						o.Type = toUninstallTypePointer(2)
					case "log", "LOG":
						o.Type = toUninstallTypePointer(3)
					case "integration", "INTEGRATION":
						o.Type = toUninstallTypePointer(4)
					case "export", "EXPORT":
						o.Type = toUninstallTypePointer(5)
					case "project", "PROJECT":
						o.Type = toUninstallTypePointer(6)
					case "repo", "REPO":
						o.Type = toUninstallTypePointer(7)
					case "user", "USER":
						o.Type = toUninstallTypePointer(8)
					case "calendar", "CALENDAR":
						o.Type = toUninstallTypePointer(9)
					case "uninstall", "UNINSTALL":
						o.Type = toUninstallTypePointer(10)
					case "upgrade", "UPGRADE":
						o.Type = toUninstallTypePointer(11)
					case "start", "START":
						o.Type = toUninstallTypePointer(12)
					case "stop", "STOP":
						o.Type = toUninstallTypePointer(13)
					case "pause", "PAUSE":
						o.Type = toUninstallTypePointer(14)
					case "resume", "RESUME":
						o.Type = toUninstallTypePointer(15)
					}
				}
			}
		}
