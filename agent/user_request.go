...
type UserRequestIntegration struct {
	...
	Authorization UserRequestIntegrationAuthorization `json:"authorization" yaml:"authorization" faker:"-"`
	...
	ValidatedDate UserRequestIntegrationValidatedDate `json:"validated_date" yaml:"validated_date" faker:"-"`
...
type UserRequest struct {
	...
	Integration UserRequestIntegration `json:"integration" yaml:"integration" faker:"-"`
	// RefID the source system id for the model instance
	RefID string `json:"ref_id" yaml:"ref_id" faker:"-"`
	// RefType the source system identifier for the model instance
	RefType string `json:"ref_type" yaml:"ref_type" faker:"-"`
	// RequestDate the date when the request was made
	RequestDate UserRequestRequestDate `json:"request_date" yaml:"request_date" faker:"-"`
