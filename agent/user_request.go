...
// UserRequestIntegrationEntityErrors represents the object structure for entity_errors
type UserRequestIntegrationEntityErrors struct {
	// ID entity id
...
func toUserRequestIntegrationEntityErrorsObject(o interface{}, isoptional bool) interface{} {
	switch v := o.(type) {
	case *UserRequestIntegrationEntityErrors:
		return v.ToMap()
...
func (o *UserRequestIntegrationEntityErrors) ToMap() map[string]interface{} {
	o.setDefaults(true)
	return map[string]interface{}{
		// ID entity id
		"id": toUserRequestIntegrationEntityErrorsObject(o.ID, false),
		// RefID entity ref_id
		"ref_id": toUserRequestIntegrationEntityErrorsObject(o.RefID, false),
		// Error error message if set integration failed when trying to export
		"error": toUserRequestIntegrationEntityErrorsObject(o.Error, false),
	}
}

func (o *UserRequestIntegrationEntityErrors) setDefaults(frommap bool) {
...
// FromMap attempts to load data into object from a map
func (o *UserRequestIntegrationEntityErrors) FromMap(kv map[string]interface{}) {
...
type UserRequestIntegration struct {
	...
	EntityErrors []UserRequestIntegrationEntityErrors `json:"entity_errors" codec:"entity_errors" bson:"entity_errors" yaml:"entity_errors" faker:"-"`
...
func (o *UserRequestIntegration) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		// EntityErrors export status and error per entity in the integration
		"entity_errors": toUserRequestIntegrationObject(o.EntityErrors, false),
		// ErrorMessage The error message from an export run
...
func (o *UserRequestIntegration) FromMap(kv map[string]interface{}) {
	...
	if o == nil {
		...
		o.EntityErrors = make([]UserRequestIntegrationEntityErrors, 0)

	}
	if val, ok := kv["entity_errors"]; ok {
		if sv, ok := val.([]UserRequestIntegrationEntityErrors); ok {
			o.EntityErrors = sv
		} else if sp, ok := val.([]*UserRequestIntegrationEntityErrors); ok {
			...
			for _, ae := range a {
				if av, ok := ae.(UserRequestIntegrationEntityErrors); ok {
					o.EntityErrors = append(o.EntityErrors, av)
				} else if av, ok := ae.(primitive.M); ok {
					var fm UserRequestIntegrationEntityErrors
					fm.FromMap(av)
					o.EntityErrors = append(o.EntityErrors, fm)
				} else {
					b, _ := json.Marshal(ae)
					var av UserRequestIntegrationEntityErrors
			...
			for _, item := range arr {
				if r, ok := item.(UserRequestIntegrationEntityErrors); ok {
					...
					fm := UserRequestIntegrationEntityErrors{}
					fm.FromMap(r)
					o.EntityErrors = append(o.EntityErrors, fm)
				}
			}
...
func (o *UserRequest) setDefaults(frommap bool) {
	if o.Integration.EntityErrors == nil {
		o.Integration.EntityErrors = make([]UserRequestIntegrationEntityErrors, 0)
	}
