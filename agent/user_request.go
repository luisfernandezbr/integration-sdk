...
func (o *UserRequestIntegrationAuthorization) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		// CollectionName Collection name for instance, if relevant
		"collection_name": toUserRequestIntegrationAuthorizationObject(o.CollectionName, true),
		// APIKey API Key for instance, if relevant
		...
		// APIVersion the api version of the integration
		"api_version": toUserRequestIntegrationAuthorizationObject(o.APIVersion, true),
		// Organization Organization for instance, if relevant
...
func (v *UserRequestIntegrationLocation) UnmarshalBSONValue(t bsontype.Type, data []byte) error {
	val := bson.RawValue{Type: t, Value: data}
	switch t {
	case bsontype.Int32:
		*v = UserRequestIntegrationLocation(val.Int32())
	case bsontype.String:
		switch val.StringValue() {
		case "PRIVATE":
			*v = UserRequestIntegrationLocation(0)
		case "CLOUD":
			*v = UserRequestIntegrationLocation(1)
		}
	}
	return nil
}
...
func (v UserRequestIntegrationLocation) UnmarshalJSON(buf []byte) error {
	switch string(buf) {
	case "PRIVATE":
		v = 0
	case "CLOUD":
...
func (v UserRequestIntegrationLocation) MarshalJSON() ([]byte, error) {
	switch v {
	case 0:
...
// UserRequestIntegrationOnboardCompletedDate represents the object structure for onboard_completed_date
type UserRequestIntegrationOnboardCompletedDate struct {
...
func toUserRequestIntegrationOnboardCompletedDateObject(o interface{}, isoptional bool) interface{} {
	switch v := o.(type) {
	case *UserRequestIntegrationOnboardCompletedDate:
		return v.ToMap()
...
func (o *UserRequestIntegrationOnboardCompletedDate) ToMap() map[string]interface{} {
	o.setDefaults(true)
	return map[string]interface{}{
		// Epoch the date in epoch format
		"epoch": toUserRequestIntegrationOnboardCompletedDateObject(o.Epoch, false),
		// Offset the timezone offset from GMT
		"offset": toUserRequestIntegrationOnboardCompletedDateObject(o.Offset, false),
		// Rfc3339 the date in RFC3339 format
		"rfc3339": toUserRequestIntegrationOnboardCompletedDateObject(o.Rfc3339, false),
	}
}

func (o *UserRequestIntegrationOnboardCompletedDate) setDefaults(frommap bool) {
...
// FromMap attempts to load data into object from a map
func (o *UserRequestIntegrationOnboardCompletedDate) FromMap(kv map[string]interface{}) {
...
// UserRequestIntegrationOnboardRequestedDate represents the object structure for onboard_requested_date
type UserRequestIntegrationOnboardRequestedDate struct {
	// Epoch the date in epoch format
	Epoch int64 `json:"epoch" codec:"epoch" bson:"epoch" yaml:"epoch" faker:"-"`
	// Offset the timezone offset from GMT
	Offset int64 `json:"offset" codec:"offset" bson:"offset" yaml:"offset" faker:"-"`
...
func toUserRequestIntegrationOnboardRequestedDateObject(o interface{}, isoptional bool) interface{} {
	switch v := o.(type) {
	case *UserRequestIntegrationOnboardRequestedDate:
		return v.ToMap()
...
func (o *UserRequestIntegrationOnboardRequestedDate) ToMap() map[string]interface{} {
	o.setDefaults(true)
	return map[string]interface{}{
		// Epoch the date in epoch format
		"epoch": toUserRequestIntegrationOnboardRequestedDateObject(o.Epoch, false),
		// Offset the timezone offset from GMT
		"offset": toUserRequestIntegrationOnboardRequestedDateObject(o.Offset, false),
		// Rfc3339 the date in RFC3339 format
		"rfc3339": toUserRequestIntegrationOnboardRequestedDateObject(o.Rfc3339, false),
	}
}

func (o *UserRequestIntegrationOnboardRequestedDate) setDefaults(frommap bool) {
...
// FromMap attempts to load data into object from a map
func (o *UserRequestIntegrationOnboardRequestedDate) FromMap(kv map[string]interface{}) {
...
// UserRequestIntegrationProjectErrors represents the object structure for project_errors
type UserRequestIntegrationProjectErrors struct {
	// ID project/repo id
...
func toUserRequestIntegrationProjectErrorsObject(o interface{}, isoptional bool) interface{} {
	switch v := o.(type) {
	case *UserRequestIntegrationProjectErrors:
		return v.ToMap()
...
func (o *UserRequestIntegrationProjectErrors) ToMap() map[string]interface{} {
	o.setDefaults(true)
	return map[string]interface{}{
		// ID project/repo id
		"id": toUserRequestIntegrationProjectErrorsObject(o.ID, false),
		// RefID project/repo ref_id
		"ref_id": toUserRequestIntegrationProjectErrorsObject(o.RefID, false),
		// ReadableID project/repo unique name or readable id
		"readable_id": toUserRequestIntegrationProjectErrorsObject(o.ReadableID, false),
		// Error if set integration failed when trying to export this project/repo
		"error": toUserRequestIntegrationProjectErrorsObject(o.Error, false),
		// HasGitRepo if true, ripsrc processing was called for this repo
		"has_git_repo": toUserRequestIntegrationProjectErrorsObject(o.HasGitRepo, false),
		// GitError if true, ripsrc failed on this repo
		"git_error": toUserRequestIntegrationProjectErrorsObject(o.GitError, false),
	}
}

func (o *UserRequestIntegrationProjectErrors) setDefaults(frommap bool) {
...
// FromMap attempts to load data into object from a map
func (o *UserRequestIntegrationProjectErrors) FromMap(kv map[string]interface{}) {
...
// UnmarshalBSONValue for unmarshaling value
func (v *UserRequestIntegrationSystemType) UnmarshalBSONValue(t bsontype.Type, data []byte) error {
	val := bson.RawValue{Type: t, Value: data}
	switch t {
	case bsontype.Int32:
		*v = UserRequestIntegrationSystemType(val.Int32())
	case bsontype.String:
		switch val.StringValue() {
		case "WORK":
			*v = UserRequestIntegrationSystemType(0)
		case "SOURCECODE":
			*v = UserRequestIntegrationSystemType(1)
		case "CODEQUALITY":
			*v = UserRequestIntegrationSystemType(2)
		case "USER":
			*v = UserRequestIntegrationSystemType(3)
		}
	}
	return nil
}
...
// UnmarshalJSON unmarshals the enum value
func (v UserRequestIntegrationSystemType) UnmarshalJSON(buf []byte) error {
	switch string(buf) {
	case "WORK":
		v = 0
	case "SOURCECODE":
...
// MarshalJSON marshals the enum value
func (v UserRequestIntegrationSystemType) MarshalJSON() ([]byte, error) {
	switch v {
	case 0:
...
type UserRequestIntegration struct {
	...
	OnboardCompletedDate UserRequestIntegrationOnboardCompletedDate `json:"onboard_completed_date" codec:"onboard_completed_date" bson:"onboard_completed_date" yaml:"onboard_completed_date" faker:"-"`
	...
	ProjectErrors []UserRequestIntegrationProjectErrors `json:"project_errors" codec:"project_errors" bson:"project_errors" yaml:"project_errors" faker:"-"`
...
func (o *UserRequestIntegration) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		// ErrorMessage The error message from an export run
		"error_message": toUserRequestIntegrationObject(o.ErrorMessage, true),
		// Errored If authorization failed by the agent
		...
		// OnboardCompletedDate when the last request for integration metadata was finished
		"onboard_completed_date": toUserRequestIntegrationObject(o.OnboardCompletedDate, false),
		// OnboardRequestedDate when the last request for integration metadata was made
		...
		// ProjectErrors export status and error per project
		"project_errors": toUserRequestIntegrationObject(o.ProjectErrors, false),
		// RefID the source system id for the model instance
		"ref_id": toUserRequestIntegrationObject(o.RefID, false),
		// RefType the source system identifier for the model instance
		"ref_type": toUserRequestIntegrationObject(o.RefType, false),
		// ServerVersion the server version for this integration
		"server_version": toUserRequestIntegrationObject(o.ServerVersion, true),
		// SystemType The system type of the integration (sourcecode / work (jira) / codequality / etc.)
...
func (o *UserRequestIntegration) FromMap(kv map[string]interface{}) {
	...
	if val, ok := kv["onboard_completed_date"]; ok {
		...
		} else if sv, ok := val.(UserRequestIntegrationOnboardCompletedDate); ok {
			// struct
			o.OnboardCompletedDate = sv
		} else if sp, ok := val.(*UserRequestIntegrationOnboardCompletedDate); ok {
			// struct pointer
	...
	if val, ok := kv["onboard_requested_date"]; ok {
		...
		} else if sv, ok := val.(UserRequestIntegrationOnboardRequestedDate); ok {
			// struct
			o.OnboardRequestedDate = sv
		} else if sp, ok := val.(*UserRequestIntegrationOnboardRequestedDate); ok {
			// struct pointer
	...
	if o == nil {
		...
		o.ProjectErrors = make([]UserRequestIntegrationProjectErrors, 0)

	}
	if val, ok := kv["project_errors"]; ok {
		if sv, ok := val.([]UserRequestIntegrationProjectErrors); ok {
			o.ProjectErrors = sv
		} else if sp, ok := val.([]*UserRequestIntegrationProjectErrors); ok {
			...
			for _, ae := range a {
				if av, ok := ae.(UserRequestIntegrationProjectErrors); ok {
					o.ProjectErrors = append(o.ProjectErrors, av)
				} else if av, ok := ae.(primitive.M); ok {
					var fm UserRequestIntegrationProjectErrors
					fm.FromMap(av)
					o.ProjectErrors = append(o.ProjectErrors, fm)
				} else {
					b, _ := json.Marshal(ae)
					var av UserRequestIntegrationProjectErrors
					if err := json.Unmarshal(b, &av); err != nil {
			...
			for _, item := range arr {
				if r, ok := item.(UserRequestIntegrationProjectErrors); ok {
					...
					fm := UserRequestIntegrationProjectErrors{}
					fm.FromMap(r)
					o.ProjectErrors = append(o.ProjectErrors, fm)
				}
			}
...
func (o *UserRequest) setDefaults(frommap bool) {
	if o.Integration.ProjectErrors == nil {
		o.Integration.ProjectErrors = make([]UserRequestIntegrationProjectErrors, 0)
	}
