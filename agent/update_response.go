...
// toUpdateResponseTypePointer is the enumeration pointer type for type
func toUpdateResponseTypePointer(v int32) *UpdateResponseType {
	nv := UpdateResponseType(v)
	return &nv
}

// toUpdateResponseTypeEnum is the enumeration pointer wrapper for type
func toUpdateResponseTypeEnum(v *UpdateResponseType) string {
	if v == nil {
		return toUpdateResponseTypePointer(0).String()
	}
	return v.String()
}
...
func (o *UpdateResponse) SetCustomerID(id string) {
	o.CustomerID = id
}
...
func (o *UpdateResponse) SetIntegrationInstanceID(id string) {
	if id == "" {
...
func (o *UpdateResponse) GetIntegrationInstanceID() *string {
...
func (o *UpdateResponsePartial) ToMap() map[string]interface{} {
	kv := map[string]interface{}{
		...
		"type":    toUpdateResponseTypeEnum(o.Type),
	...
	for k, v := range kv {
		if v == nil || reflect.ValueOf(v).IsZero() {
			...
			if k == "event_date" {
				if dt, ok := v.(*UpdateResponseEventDate); ok {
			...
			if k == "last_export_date" {
				if dt, ok := v.(*UpdateResponseLastExportDate); ok {
					if dt.Epoch == 0 && dt.Offset == 0 && dt.Rfc3339 == "" {
						delete(kv, k)
					}
				}
...
// MarshalJSON returns the bytes for marshaling to json
func (o *UpdateResponsePartial) MarshalJSON() ([]byte, error) {
	return json.Marshal(o.ToMap())
}

// UnmarshalJSON will unmarshal the json buffer into the object
func (o *UpdateResponsePartial) UnmarshalJSON(data []byte) error {
	kv := make(map[string]interface{})
	if err := json.Unmarshal(data, &kv); err != nil {
		return err
	}
...
func (o *UpdateResponsePartial) setDefaults(frommap bool) {
}

// FromMap attempts to load data into object from a map
func (o *UpdateResponsePartial) FromMap(kv map[string]interface{}) {
	if val, ok := kv["architecture"].(*string); ok {
		o.Architecture = val
	...
	if o.EventDate == nil {
		o.EventDate = &UpdateResponseEventDate{}
	}
	...
	if val, ok := kv["from_version"].(*string); ok {
		o.FromVersion = val
	} else if val, ok := kv["from_version"].(string); ok {
		o.FromVersion = &val
	} else {
		if val, ok := kv["from_version"]; ok {
			if val == nil {
				o.FromVersion = pstrings.Pointer("")
			} else {
				// if coming in as map, convert it back
				if kv, ok := val.(map[string]interface{}); ok {
					val = kv["string"]
				}
				o.FromVersion = pstrings.Pointer(fmt.Sprintf("%v", val))
			}
		}
	}
	if val, ok := kv["go_version"].(*string); ok {
	...
	if o.LastExportDate == nil {
		o.LastExportDate = &UpdateResponseLastExportDate{}
	}
	...
	if val, ok := kv["type"].(*UpdateResponseType); ok {
		o.Type = val
	} else if val, ok := kv["type"].(UpdateResponseType); ok {
		o.Type = &val
	} else {
		if val, ok := kv["type"]; ok {
			if val == nil {
				o.Type = toUpdateResponseTypePointer(0)
			} else {
				// if coming in as map, convert it back
				if kv, ok := val.(map[string]interface{}); ok {
					val = kv["UpdateResponseType"]
				}
				...
				if em, ok := val.(string); ok {
					...
					case "enroll", "ENROLL":
						o.Type = toUpdateResponseTypePointer(0)
					case "ping", "PING":
						o.Type = toUpdateResponseTypePointer(1)
					case "crash", "CRASH":
						o.Type = toUpdateResponseTypePointer(2)
					case "log", "LOG":
						o.Type = toUpdateResponseTypePointer(3)
					case "integration", "INTEGRATION":
						o.Type = toUpdateResponseTypePointer(4)
					case "export", "EXPORT":
						o.Type = toUpdateResponseTypePointer(5)
					case "project", "PROJECT":
						o.Type = toUpdateResponseTypePointer(6)
					case "repo", "REPO":
						o.Type = toUpdateResponseTypePointer(7)
					case "user", "USER":
						o.Type = toUpdateResponseTypePointer(8)
					case "calendar", "CALENDAR":
						o.Type = toUpdateResponseTypePointer(9)
					case "uninstall", "UNINSTALL":
						o.Type = toUpdateResponseTypePointer(10)
					case "upgrade", "UPGRADE":
						o.Type = toUpdateResponseTypePointer(11)
					case "start", "START":
						o.Type = toUpdateResponseTypePointer(12)
					case "stop", "STOP":
						o.Type = toUpdateResponseTypePointer(13)
					case "pause", "PAUSE":
						o.Type = toUpdateResponseTypePointer(14)
					case "resume", "RESUME":
						o.Type = toUpdateResponseTypePointer(15)
					}
				}
			}
		}
