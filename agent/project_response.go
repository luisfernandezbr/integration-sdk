...
type ProjectResponseLastUser struct {
	...
	AvatarURL string `json:"avatar_url" bson:"avatar_url" yaml:"avatar_url" faker:"true"`
	// Name the user name
	Name string `json:"name" bson:"name" yaml:"name" faker:"true"`
...
const (
	...
	ProjectResponseTypeUser ProjectResponseType = 6
...
func toProjectResponseObject(o interface{}, isavro bool, isoptional bool, avrotype string) interface{} {
	...
	case *ProjectResponseEventDate:
		return map[string]interface{}{
			"agent.event_date": (*o.(*ProjectResponseEventDate)).ToMap(),
		}
	case []ProjectResponseEventDate:
		arr := make([]interface{}, 0)
		for _, i := range o.([]ProjectResponseEventDate) {
			arr = append(arr, i.ToMap())
		}
		return arr
	case *[]ProjectResponseEventDate:
...
func GetProjectResponseAvroSchemaSpec() string {
	spec := map[string]interface{}{
		...
		"fields": []map[string]interface{}{
			...
			map[string]interface{}{
				"name": "event_date",
				"type": map[string]interface{}{"fields": []interface{}{map[string]interface{}{"name": "epoch", "doc": "the date in epoch format", "type": "long"}, map[string]interface{}{"type": "long", "name": "offset", "doc": "the timezone offset from GMT"}, map[string]interface{}{"name": "rfc3339", "doc": "the date in RFC3339 format", "type": "string"}}, "doc": "the date of the event", "type": "record", "name": "event_date"},
			},
			map[string]interface{}{
				"name": "free_space",
				"type": "long",
			...
			map[string]interface{}{
				"name": "projects",
				"type": map[string]interface{}{"type": "array", "name": "projects", "items": map[string]interface{}{"fields": []interface{}{map[string]interface{}{"type": "boolean", "name": "active", "doc": "the status of the project"}, map[string]interface{}{"type": "string", "name": "category", "doc": "the project category"}, map[string]interface{}{"type": map[string]interface{}{"doc": "the date of the change", "type": "record", "name": "projects.created_date", "fields": []interface{}{map[string]interface{}{"type": "long", "name": "epoch", "doc": "the date in epoch format"}, map[string]interface{}{"type": "long", "name": "offset", "doc": "the timezone offset from GMT"}, map[string]interface{}{"type": "string", "name": "rfc3339", "doc": "the date in RFC3339 format"}}}, "name": "created_date", "doc": "the date of the change"}, map[string]interface{}{"type": "string", "name": "description", "doc": "the description of the project"}, map[string]interface{}{"doc": "the common identifier for the project", "type": "string", "name": "identifier"}, map[string]interface{}{"type": map[string]interface{}{"fields": []interface{}{map[string]interface{}{"type": map[string]interface{}{"fields": []interface{}{}, "doc": "the date of the change", "type": "record", "name": "last_issue.created_date"}, "name": "created_date", "doc": "the date of the change"}, map[string]interface{}{"type": "string", "name": "identifier", "doc": "the issue key from the source"}, map[string]interface{}{"type": "string", "name": "issue_id", "doc": "issue id"}, map[string]interface{}{"type": map[string]interface{}{"name": "last_issue.last_user", "fields": []interface{}{map[string]interface{}{"doc": "the work project user id", "type": "string", "name": "user_id"}, map[string]interface{}{"name": "name", "doc": "the user name", "type": "string"}, map[string]interface{}{"type": "string", "name": "avatar_url", "doc": "the avatar url"}}, "doc": "the last user", "type": "record"}, "name": "last_user", "doc": "the last user"}}, "doc": "last issue for this project", "type": "record", "name": "projects.last_issue"}, "name": "last_issue", "doc": "last issue for this project"}, map[string]interface{}{"name": "last_user", "doc": "the last user", "type": map[string]interface{}{"fields": []interface{}{map[string]interface{}{"doc": "the avatar url", "type": "string", "name": "avatar_url"}, map[string]interface{}{"doc": "the user name", "type": "string", "name": "name"}, map[string]interface{}{"type": "string", "name": "user_id", "doc": "the work project user id"}}, "doc": "the last user", "type": "record", "name": "projects.last_user"}}, map[string]interface{}{"type": "string", "name": "name", "doc": "the name of the project"}, map[string]interface{}{"doc": "the id of the project", "type": "string", "name": "project_id"}, map[string]interface{}{"name": "total_issues", "doc": "the total issues count for the project", "type": "long"}, map[string]interface{}{"name": "url", "doc": "the url to the project home page", "type": "string"}}, "doc": "the projects exported", "type": "record", "name": "projects"}},
			},
			map[string]interface{}{
				"name": "ref_id",
				"type": "string",
