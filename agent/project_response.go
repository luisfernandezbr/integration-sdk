...
func GetProjectResponseAvroSchemaSpec() string {
	spec := map[string]interface{}{
		...
		"fields": []map[string]interface{}{
			...
			map[string]interface{}{
				"name": "projects",
				"type": map[string]interface{}{"items": map[string]interface{}{"doc": "the projects exported", "fields": []interface{}{map[string]interface{}{"doc": "the status of the project", "name": "active", "type": "boolean"}, map[string]interface{}{"default": nil, "doc": "the project category", "name": "category", "type": []interface{}{"null", "string"}}, map[string]interface{}{"doc": "the customer id for the model instance", "name": "customer_id", "type": "string"}, map[string]interface{}{"default": nil, "doc": "the description of the project", "name": "description", "type": []interface{}{"null", "string"}}, map[string]interface{}{"doc": "the primary key for the model instance", "name": "id", "type": "string"}, map[string]interface{}{"doc": "the common identifier for the project", "name": "identifier", "type": "string"}, map[string]interface{}{"doc": "last issue for this project", "name": "last_issue", "type": map[string]interface{}{"doc": "last issue for this project", "fields": []interface{}{map[string]interface{}{"doc": "issue id", "name": "issue_id", "type": "string"}, map[string]interface{}{"doc": "the issue key from the source", "name": "identifier", "type": "string"}, map[string]interface{}{"doc": "the date of the change", "name": "created_date", "type": map[string]interface{}{"doc": "the date of the change", "fields": []interface{}{map[string]interface{}{"doc": "the customer id for the model instance", "name": "customer_id", "type": "string"}, map[string]interface{}{"doc": "the date in epoch format", "name": "epoch", "type": "long"}, map[string]interface{}{"doc": "the primary key for the model instance", "name": "id", "type": "string"}, map[string]interface{}{"doc": "the timezone offset from GMT", "name": "offset", "type": "long"}, map[string]interface{}{"doc": "the source system id for the model instance", "name": "ref_id", "type": "string"}, map[string]interface{}{"doc": "the source system identifier for the model instance", "name": "ref_type", "type": "string"}, map[string]interface{}{"doc": "the date in RFC3339 format", "name": "rfc3339", "type": "string"}}, "name": "last_issue.created_date", "type": "record"}}, map[string]interface{}{"doc": "the last user", "name": "last_user", "type": map[string]interface{}{"doc": "the last user", "fields": []interface{}{map[string]interface{}{"doc": "the work project user id", "name": "user_id", "type": "string"}, map[string]interface{}{"doc": "the user name", "name": "name", "type": "string"}, map[string]interface{}{"doc": "the avatar url", "name": "avatar_url", "type": "string"}}, "name": "last_issue.last_user", "type": "record"}}}, "name": "projects.last_issue", "type": "record"}}, map[string]interface{}{"doc": "the name of the project", "name": "name", "type": "string"}, map[string]interface{}{"doc": "the id of the project", "name": "project_id", "type": "string"}, map[string]interface{}{"doc": "the source system id for the model instance", "name": "ref_id", "type": "string"}, map[string]interface{}{"doc": "the source system identifier for the model instance", "name": "ref_type", "type": "string"}, map[string]interface{}{"doc": "the total issues count for the project", "name": "total_issues", "type": "long"}, map[string]interface{}{"doc": "the url to the project home page", "name": "url", "type": "string"}}, "name": "projects", "type": "record"}, "name": "projects", "type": "array"},
			},
			map[string]interface{}{
				"name": "ref_id",
				"type": "string",
