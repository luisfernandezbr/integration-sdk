...
func GetProjectResponseAvroSchemaSpec() string {
	spec := map[string]interface{}{
		...
		"fields": []map[string]interface{}{
			...
			map[string]interface{}{
				"name": "projects",
				"type": map[string]interface{}{"type": "array", "name": "projects", "items": map[string]interface{}{"name": "projects", "fields": []interface{}{map[string]interface{}{"type": "boolean", "name": "active", "doc": "the status of the project"}, map[string]interface{}{"type": "string", "name": "category", "doc": "the project category"}, map[string]interface{}{"doc": "project created timestamp", "type": "long", "name": "created_ts"}, map[string]interface{}{"name": "description", "doc": "the description of the project", "type": "string"}, map[string]interface{}{"type": "string", "name": "identifier", "doc": "the common identifier for the project"}, map[string]interface{}{"type": "string", "name": "name", "doc": "the name of the project"}, map[string]interface{}{"doc": "the id of the project", "type": "string", "name": "project_id"}, map[string]interface{}{"type": "string", "name": "url", "doc": "the url to the project home page"}}, "doc": "the projects exported", "type": "record"}},
			},
			map[string]interface{}{
				"name": "ref_id",
				"type": "string",
