...
func GetProjectResponseAvroSchemaSpec() string {
	spec := map[string]interface{}{
		...
		"fields": []map[string]interface{}{
			...
			map[string]interface{}{
				"name": "projects",
				"type": map[string]interface{}{"items": map[string]interface{}{"type": "record", "name": "projects", "fields": []interface{}{map[string]interface{}{"name": "active", "doc": "the status of the project", "type": "boolean"}, map[string]interface{}{"type": "string", "name": "category", "doc": "the project category"}, map[string]interface{}{"doc": "the description of the project", "type": "string", "name": "description"}, map[string]interface{}{"type": "string", "name": "identifier", "doc": "the common identifier for the project"}, map[string]interface{}{"name": "last_issue", "doc": "last issue for this project", "type": map[string]interface{}{"fields": []interface{}{map[string]interface{}{"type": "string", "name": "created", "doc": "the date of the change in RFC3339 format"}, map[string]interface{}{"type": "string", "name": "identifier", "doc": "the issue key from the source"}, map[string]interface{}{"type": "string", "name": "issue_id", "doc": "issue id"}, map[string]interface{}{"doc": "the last user", "type": map[string]interface{}{"fields": []interface{}{map[string]interface{}{"type": "string", "name": "user_id", "doc": "the work project user id"}, map[string]interface{}{"type": "string", "name": "name", "doc": "the user name"}, map[string]interface{}{"type": "string", "name": "avatar_url", "doc": "the avatar url"}}, "doc": "the last user", "type": "record", "name": "last_issue.last_user"}, "name": "last_user"}}, "doc": "last issue for this project", "type": "record", "name": "projects.last_issue"}}, map[string]interface{}{"type": map[string]interface{}{"type": "record", "name": "projects.last_user", "fields": []interface{}{map[string]interface{}{"doc": "the avatar url", "type": "string", "name": "avatar_url"}, map[string]interface{}{"doc": "the user name", "type": "string", "name": "name"}, map[string]interface{}{"type": "string", "name": "user_id", "doc": "the work project user id"}}, "doc": "the last user"}, "name": "last_user", "doc": "the last user"}, map[string]interface{}{"type": "string", "name": "name", "doc": "the name of the project"}, map[string]interface{}{"doc": "the id of the project", "type": "string", "name": "project_id"}, map[string]interface{}{"doc": "the total issues count for the project", "type": "long", "name": "total_issues"}, map[string]interface{}{"type": "string", "name": "url", "doc": "the url to the project home page"}}, "doc": "the projects exported"}, "type": "array", "name": "projects"},
			},
			map[string]interface{}{
				"name": "ref_id",
				"type": "string",
