...
// toCalendarResponseTypePointer is the enumeration pointer type for type
func toCalendarResponseTypePointer(v int32) *CalendarResponseType {
	nv := CalendarResponseType(v)
	return &nv
}

// toCalendarResponseTypeEnum is the enumeration pointer wrapper for type
func toCalendarResponseTypeEnum(v *CalendarResponseType) string {
	if v == nil {
		return toCalendarResponseTypePointer(0).String()
	}
	return v.String()
}
...
func (o *CalendarResponse) SetEventHeaders(kv map[string]string) {
	kv["customer_id"] = o.CustomerID
	kv["model"] = CalendarResponseModelName.String()
}
...
func (o *CalendarResponse) SetCustomerID(id string) {
...
func (o *CalendarResponsePartial) ToMap() map[string]interface{} {
	kv := map[string]interface{}{
		...
		"type":    toCalendarResponseTypeEnum(o.Type),
	...
	for k, v := range kv {
		if v == nil || reflect.ValueOf(v).IsZero() {
			...
			if k == "calendars" {
				if arr, ok := v.([]CalendarResponseCalendars); ok {
					if len(arr) == 0 {
						delete(kv, k)
					}
				}
			...
			if k == "event_date" {
				if dt, ok := v.(*CalendarResponseEventDate); ok {
			...
			if k == "last_export_date" {
				if dt, ok := v.(*CalendarResponseLastExportDate); ok {
					if dt.Epoch == 0 && dt.Offset == 0 && dt.Rfc3339 == "" {
						delete(kv, k)
					}
				}
...
// MarshalJSON returns the bytes for marshaling to json
func (o *CalendarResponsePartial) MarshalJSON() ([]byte, error) {
	return json.Marshal(o.ToMap())
}

// UnmarshalJSON will unmarshal the json buffer into the object
func (o *CalendarResponsePartial) UnmarshalJSON(data []byte) error {
	kv := make(map[string]interface{})
	if err := json.Unmarshal(data, &kv); err != nil {
		return err
	}
...
func (o *CalendarResponsePartial) setDefaults(frommap bool) {
}

// FromMap attempts to load data into object from a map
func (o *CalendarResponsePartial) FromMap(kv map[string]interface{}) {
	if val, ok := kv["architecture"].(*string); ok {
		o.Architecture = val
	...
	if o.EventDate == nil {
		o.EventDate = &CalendarResponseEventDate{}
	}
	...
	if o.LastExportDate == nil {
		o.LastExportDate = &CalendarResponseLastExportDate{}
	}
	...
	if val, ok := kv["type"].(*CalendarResponseType); ok {
		o.Type = val
	} else if val, ok := kv["type"].(CalendarResponseType); ok {
		o.Type = &val
	} else {
		if val, ok := kv["type"]; ok {
			if val == nil {
				o.Type = toCalendarResponseTypePointer(0)
			} else {
				// if coming in as map, convert it back
				if kv, ok := val.(map[string]interface{}); ok {
					val = kv["CalendarResponseType"]
				}
				...
				if em, ok := val.(string); ok {
					...
					case "enroll", "ENROLL":
						o.Type = toCalendarResponseTypePointer(0)
					case "ping", "PING":
						o.Type = toCalendarResponseTypePointer(1)
					case "crash", "CRASH":
						o.Type = toCalendarResponseTypePointer(2)
					case "log", "LOG":
						o.Type = toCalendarResponseTypePointer(3)
					case "integration", "INTEGRATION":
						o.Type = toCalendarResponseTypePointer(4)
					case "export", "EXPORT":
						o.Type = toCalendarResponseTypePointer(5)
					case "project", "PROJECT":
						o.Type = toCalendarResponseTypePointer(6)
					case "repo", "REPO":
						o.Type = toCalendarResponseTypePointer(7)
					case "user", "USER":
						o.Type = toCalendarResponseTypePointer(8)
					case "calendar", "CALENDAR":
						o.Type = toCalendarResponseTypePointer(9)
					case "uninstall", "UNINSTALL":
						o.Type = toCalendarResponseTypePointer(10)
					case "upgrade", "UPGRADE":
						o.Type = toCalendarResponseTypePointer(11)
					case "start", "START":
						o.Type = toCalendarResponseTypePointer(12)
					case "stop", "STOP":
						o.Type = toCalendarResponseTypePointer(13)
					case "pause", "PAUSE":
						o.Type = toCalendarResponseTypePointer(14)
					case "resume", "RESUME":
						o.Type = toCalendarResponseTypePointer(15)
					}
				}
			}
		}
