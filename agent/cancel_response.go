...
// toCancelResponseTypePointer is the enumeration pointer type for type
func toCancelResponseTypePointer(v int32) *CancelResponseType {
	nv := CancelResponseType(v)
	return &nv
}

// toCancelResponseTypeEnum is the enumeration pointer wrapper for type
func toCancelResponseTypeEnum(v *CancelResponseType) string {
	if v == nil {
		return toCancelResponseTypePointer(0).String()
	}
	return v.String()
}
...
func (o *CancelResponse) SetCustomerID(id string) {
	o.CustomerID = id
}

// GetRefType will return the ref_type
func (o *CancelResponse) GetRefType() string {
	return o.RefType
}

// SetRefType will return the ref_type
func (o *CancelResponse) SetRefType(t string) {
	o.RefType = t
}
...
func (o *CancelResponsePartial) ToMap() map[string]interface{} {
	kv := map[string]interface{}{
		...
		"type":    toCancelResponseTypeEnum(o.Type),
	...
	for k, v := range kv {
		if v == nil || reflect.ValueOf(v).IsZero() {
			...
			if k == "cancel_date" {
				if dt, ok := v.(*CancelResponseCancelDate); ok {
			...
			if k == "event_date" {
				if dt, ok := v.(*CancelResponseEventDate); ok {
					if dt.Epoch == 0 && dt.Offset == 0 && dt.Rfc3339 == "" {
						delete(kv, k)
					}
				}
			...
			if k == "last_export_date" {
				if dt, ok := v.(*CancelResponseLastExportDate); ok {
					if dt.Epoch == 0 && dt.Offset == 0 && dt.Rfc3339 == "" {
						delete(kv, k)
					}
				}
...
// MarshalJSON returns the bytes for marshaling to json
func (o *CancelResponsePartial) MarshalJSON() ([]byte, error) {
	return json.Marshal(o.ToMap())
}

// UnmarshalJSON will unmarshal the json buffer into the object
func (o *CancelResponsePartial) UnmarshalJSON(data []byte) error {
	kv := make(map[string]interface{})
	if err := json.Unmarshal(data, &kv); err != nil {
		return err
	}
...
func (o *CancelResponsePartial) setDefaults(frommap bool) {
}

// FromMap attempts to load data into object from a map
func (o *CancelResponsePartial) FromMap(kv map[string]interface{}) {
	if val, ok := kv["architecture"].(*string); ok {
		o.Architecture = val
	...
	if o.CancelDate == nil {
		o.CancelDate = &CancelResponseCancelDate{}
	}
	...
	if o.EventDate == nil {
		o.EventDate = &CancelResponseEventDate{}
	}
	...
	if o.LastExportDate == nil {
		o.LastExportDate = &CancelResponseLastExportDate{}
	}
	...
	if val, ok := kv["type"].(*CancelResponseType); ok {
		o.Type = val
	} else if val, ok := kv["type"].(CancelResponseType); ok {
		o.Type = &val
	} else {
		if val, ok := kv["type"]; ok {
			if val == nil {
				o.Type = toCancelResponseTypePointer(0)
			} else {
				// if coming in as map, convert it back
				if kv, ok := val.(map[string]interface{}); ok {
					val = kv["CancelResponseType"]
				}
				...
				if em, ok := val.(string); ok {
					...
					case "enroll", "ENROLL":
						o.Type = toCancelResponseTypePointer(0)
					case "ping", "PING":
						o.Type = toCancelResponseTypePointer(1)
					case "crash", "CRASH":
						o.Type = toCancelResponseTypePointer(2)
					case "log", "LOG":
						o.Type = toCancelResponseTypePointer(3)
					case "integration", "INTEGRATION":
						o.Type = toCancelResponseTypePointer(4)
					case "export", "EXPORT":
						o.Type = toCancelResponseTypePointer(5)
					case "project", "PROJECT":
						o.Type = toCancelResponseTypePointer(6)
					case "repo", "REPO":
						o.Type = toCancelResponseTypePointer(7)
					case "user", "USER":
						o.Type = toCancelResponseTypePointer(8)
					case "calendar", "CALENDAR":
						o.Type = toCancelResponseTypePointer(9)
					case "uninstall", "UNINSTALL":
						o.Type = toCancelResponseTypePointer(10)
					case "upgrade", "UPGRADE":
						o.Type = toCancelResponseTypePointer(11)
					case "start", "START":
						o.Type = toCancelResponseTypePointer(12)
					case "stop", "STOP":
						o.Type = toCancelResponseTypePointer(13)
					case "pause", "PAUSE":
						o.Type = toCancelResponseTypePointer(14)
					case "resume", "RESUME":
						o.Type = toCancelResponseTypePointer(15)
					}
				}
			}
		}
