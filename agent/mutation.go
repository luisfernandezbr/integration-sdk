...
const (
	...
	// MutationModelSessionIDColumn is the column json value session_id
	MutationModelSessionIDColumn = "session_id"
)
...
func (o *Mutation) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"session_id":              toMutationObject(o.SessionID, false),
...
func (o *MutationPartial) ToMap() map[string]interface{} {
	kv := map[string]interface{}{
		...
		"session_id": toMutationObject(o.SessionID, true),
	}
	for k, v := range kv {
