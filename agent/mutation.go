...
const (
	...
	// MutationModelErrorColumn is the column json value error
	MutationModelErrorColumn = "error"
	...
	// MutationModelSuccessColumn is the column json value success
	MutationModelSuccessColumn = "success"
)
...
func (o *Mutation) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"success":                 toMutationObject(o.Success, false),
