...
const (
	...
	// Oauth1UserIdentityResponseModelErrorColumn is the column json value error
	Oauth1UserIdentityResponseModelErrorColumn = "error"
	...
	// Oauth1UserIdentityResponseModelSessionIDColumn is the column json value session_id
	Oauth1UserIdentityResponseModelSessionIDColumn = "session_id"
...
type Oauth1UserIdentityResponse struct {
	...
	// Error if the request was not successful the error message
...
func (o *Oauth1UserIdentityResponse) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"error":                   toOauth1UserIdentityResponseObject(o.Error, true),
		...
		"session_id":              toOauth1UserIdentityResponseObject(o.SessionID, false),
...
func (o *Oauth1UserIdentityResponsePartial) ToMap() map[string]interface{} {
	kv := map[string]interface{}{
		"error":      toOauth1UserIdentityResponseObject(o.Error, true),
		"identity":   toOauth1UserIdentityResponseObject(o.Identity, true),
		"session_id": toOauth1UserIdentityResponseObject(o.SessionID, true),
