...
const (
	...
	BoardTopic datamodel.TopicNameType = "work_agile_Board"

	// BoardTable is the default table name
	BoardTable datamodel.ModelNameType = "work_agile_board"

	// BoardModelName is the model name
	BoardModelName datamodel.ModelNameType = "work.agile.Board"
)
...
func (o *Board) String() string {
	return fmt.Sprintf("work.agile.Board<%s>", o.ID)
}
