...
const (
	...
	SprintTopic datamodel.TopicNameType = "work_agile_Sprint"

	// SprintTable is the default table name
	SprintTable datamodel.ModelNameType = "work_agile_sprint"

	// SprintModelName is the model name
	SprintModelName datamodel.ModelNameType = "work.agile.Sprint"
)
...
const (
	...
	// SprintModelClosedDateColumn is the column json value closed_date
	SprintModelClosedDateColumn = "closed_date"
	// SprintModelClosedDateEpochColumn is the column json value epoch
	SprintModelClosedDateEpochColumn = "epoch"
	// SprintModelClosedDateOffsetColumn is the column json value offset
	SprintModelClosedDateOffsetColumn = "offset"
	// SprintModelClosedDateRfc3339Column is the column json value rfc3339
	SprintModelClosedDateRfc3339Column = "rfc3339"
	...
	// SprintModelEndDateColumn is the column json value end_date
	SprintModelEndDateColumn = "end_date"
	// SprintModelEndDateEpochColumn is the column json value epoch
	SprintModelEndDateEpochColumn = "epoch"
	// SprintModelEndDateOffsetColumn is the column json value offset
	SprintModelEndDateOffsetColumn = "offset"
	// SprintModelEndDateRfc3339Column is the column json value rfc3339
	SprintModelEndDateRfc3339Column = "rfc3339"
	...
	// SprintModelStartDateColumn is the column json value start_date
	SprintModelStartDateColumn = "start_date"
	// SprintModelStartDateEpochColumn is the column json value epoch
	SprintModelStartDateEpochColumn = "epoch"
	// SprintModelStartDateOffsetColumn is the column json value offset
	SprintModelStartDateOffsetColumn = "offset"
	// SprintModelStartDateRfc3339Column is the column json value rfc3339
	SprintModelStartDateRfc3339Column = "rfc3339"
...
// SprintClosedDate represents the object structure for closed_date
type SprintClosedDate struct {
...
func toSprintClosedDateObject(o interface{}, isoptional bool) interface{} {
	switch v := o.(type) {
	case *SprintClosedDate:
		return v.ToMap()
...
func (o *SprintClosedDate) ToMap() map[string]interface{} {
	o.setDefaults(true)
	return map[string]interface{}{
		// Epoch the date in epoch format
		"epoch": toSprintClosedDateObject(o.Epoch, false),
		// Offset the timezone offset from GMT
		"offset": toSprintClosedDateObject(o.Offset, false),
		// Rfc3339 the date in RFC3339 format
		"rfc3339": toSprintClosedDateObject(o.Rfc3339, false),
	}
}

func (o *SprintClosedDate) setDefaults(frommap bool) {
...
func (o *SprintClosedDate) FromMap(kv map[string]interface{}) {
...
// SprintEndDate represents the object structure for end_date
type SprintEndDate struct {
	// Epoch the date in epoch format
	Epoch int64 `json:"epoch" codec:"epoch" bson:"epoch" yaml:"epoch" faker:"-"`
	// Offset the timezone offset from GMT
	Offset int64 `json:"offset" codec:"offset" bson:"offset" yaml:"offset" faker:"-"`
...
func toSprintEndDateObject(o interface{}, isoptional bool) interface{} {
	switch v := o.(type) {
	case *SprintEndDate:
		return v.ToMap()
...
// ToMap returns the object as a map
func (o *SprintEndDate) ToMap() map[string]interface{} {
	o.setDefaults(true)
	return map[string]interface{}{
		// Epoch the date in epoch format
		"epoch": toSprintEndDateObject(o.Epoch, false),
		// Offset the timezone offset from GMT
		"offset": toSprintEndDateObject(o.Offset, false),
		// Rfc3339 the date in RFC3339 format
		"rfc3339": toSprintEndDateObject(o.Rfc3339, false),
	}
}

func (o *SprintEndDate) setDefaults(frommap bool) {
...
// FromMap attempts to load data into object from a map
func (o *SprintEndDate) FromMap(kv map[string]interface{}) {
...
// SprintStartDate represents the object structure for start_date
type SprintStartDate struct {
	// Epoch the date in epoch format
	Epoch int64 `json:"epoch" codec:"epoch" bson:"epoch" yaml:"epoch" faker:"-"`
	// Offset the timezone offset from GMT
	Offset int64 `json:"offset" codec:"offset" bson:"offset" yaml:"offset" faker:"-"`
...
func toSprintStartDateObject(o interface{}, isoptional bool) interface{} {
	switch v := o.(type) {
...
// ToMap returns the object as a map
func (o *SprintStartDate) ToMap() map[string]interface{} {
	o.setDefaults(true)
	return map[string]interface{}{
		// Epoch the date in epoch format
		"epoch": toSprintStartDateObject(o.Epoch, false),
		// Offset the timezone offset from GMT
		"offset": toSprintStartDateObject(o.Offset, false),
		// Rfc3339 the date in RFC3339 format
		"rfc3339": toSprintStartDateObject(o.Rfc3339, false),
	}
}

func (o *SprintStartDate) setDefaults(frommap bool) {
...
// FromMap attempts to load data into object from a map
func (o *SprintStartDate) FromMap(kv map[string]interface{}) {
...
const (
	...
	SprintStatusClosed SprintStatus = 0
	// SprintStatusActive is the enumeration value for active
	SprintStatusActive SprintStatus = 1
	// SprintStatusFuture is the enumeration value for future
	SprintStatusFuture SprintStatus = 2
)

// Sprint a sprint specific board
type Sprint struct {
	...
	// ClosedDate the date that the sprint was closed
	ClosedDate SprintClosedDate `json:"closed_date" codec:"closed_date" bson:"closed_date" yaml:"closed_date" faker:"-"`
	...
	EndDate SprintEndDate `json:"end_date" codec:"end_date" bson:"end_date" yaml:"end_date" faker:"-"`
	// Goal the goal of the sprint
	Goal *string `json:"goal,omitempty" codec:"goal,omitempty" bson:"goal" yaml:"goal,omitempty" faker:"-"`
	...
	StartDate SprintStartDate `json:"start_date" codec:"start_date" bson:"start_date" yaml:"start_date" faker:"-"`
...
func (o *Sprint) String() string {
	return fmt.Sprintf("work.agile.Sprint<%s>", o.ID)
}
...
func (o *Sprint) ToMap() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"board_id":                toSprintObject(o.BoardID, false),
		"closed_date":             toSprintObject(o.ClosedDate, false),
		...
		"end_date":                toSprintObject(o.EndDate, false),
		...
		"start_date":              toSprintObject(o.StartDate, false),
...
func (o *Sprint) FromMap(kv map[string]interface{}) {
	...
	if val, ok := kv["closed_date"]; ok {
		...
		} else if sv, ok := val.(SprintClosedDate); ok {
			// struct
			o.ClosedDate = sv
		} else if sp, ok := val.(*SprintClosedDate); ok {
			// struct pointer
			o.ClosedDate = *sp
	...
	if val, ok := kv["end_date"]; ok {
		...
		} else if sv, ok := val.(SprintEndDate); ok {
			// struct
			o.EndDate = sv
		} else if sp, ok := val.(*SprintEndDate); ok {
			// struct pointer
			o.EndDate = *sp
		} else if dt, ok := val.(*datetime.Date); ok && dt != nil {
	...
	if val, ok := kv["start_date"]; ok {
		...
		} else if sv, ok := val.(SprintStartDate); ok {
			// struct
			o.StartDate = sv
		} else if sp, ok := val.(*SprintStartDate); ok {
			// struct pointer
			o.StartDate = *sp
		} else if dt, ok := val.(*datetime.Date); ok && dt != nil {
	...
	if val, ok := kv["status"].(SprintStatus); ok {
		...
		if em, ok := kv["status"].(map[string]interface{}); ok {
			...
			ev := em["work.agile.status"].(string)
			switch ev {
			case "closed", "CLOSED":
				o.Status = 0
			case "active", "ACTIVE":
...
type SprintPartial struct {
	...
	// ClosedDate the date that the sprint was closed
	ClosedDate *SprintClosedDate `json:"closed_date,omitempty"`
	// Columns the columns for the board in the order that they are displayed and the issue ids for each
	Columns []SprintColumns `json:"columns,omitempty"`
	// Deleted indicates that this board was deleted by the user and shouldn't be shown in the app
	Deleted *bool `json:"deleted,omitempty"`
	// EndDate the end date of the sprint
	EndDate *SprintEndDate `json:"end_date,omitempty"`
	// Goal the goal of the sprint
	...
	// StartDate the start date of the sprint
	StartDate *SprintStartDate `json:"start_date,omitempty"`
	// Status the status of the sprint
...
func (o *SprintPartial) ToMap() map[string]interface{} {
	...
	for k, v := range kv {
		if v == nil || reflect.ValueOf(v).IsZero() {
			...
			if k == "closed_date" {
				if dt, ok := v.(*SprintClosedDate); ok {
