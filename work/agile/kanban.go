...
const (
	...
	KanbanTopic datamodel.TopicNameType = "work_agile_Kanban"

	// KanbanTable is the default table name
	KanbanTable datamodel.ModelNameType = "work_agile_kanban"

	// KanbanModelName is the model name
	KanbanModelName datamodel.ModelNameType = "work.agile.Kanban"
)
...
func (o *Kanban) String() string {
	return fmt.Sprintf("work.agile.Kanban<%s>", o.ID)
}
