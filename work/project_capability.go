...
func (v *ProjectCapabilityIssueMutationFieldsType) UnmarshalBSONValue(t bsontype.Type, data []byte) error {
	...
	case bsontype.String:
		...
		case "DATE":
			*v = ProjectCapabilityIssueMutationFieldsType(11)
		}
	}
	return nil
}
...
const (
	...
	// ProjectCapabilityIssueMutationFieldsTypeDate is the enumeration value for date
	ProjectCapabilityIssueMutationFieldsTypeDate ProjectCapabilityIssueMutationFieldsType = 11
)
