...
func toChangelogCreatedDateObjectNil(isavro bool, isoptional bool) interface{} {
...
func toChangelogCreatedDateObject(o interface{}, isavro bool, isoptional bool, avrotype string) interface{} {
...
func (o *ChangelogCreatedDate) ToMap(avro ...bool) map[string]interface{} {
	var isavro bool
	...
	return map[string]interface{}{
		// Epoch the date in epoch format
		"epoch": toChangelogCreatedDateObject(o.Epoch, isavro, false, "long"),
		// Offset the timezone offset from GMT
		"offset": toChangelogCreatedDateObject(o.Offset, isavro, false, "long"),
		// Rfc3339 the date in RFC3339 format
		"rfc3339": toChangelogCreatedDateObject(o.Rfc3339, isavro, false, "string"),
	}
}
...
var cachedCodecChangelogLock sync.Mutex

// GetAvroCodec returns the avro codec for this model
func (o *Changelog) GetAvroCodec() *goavro.Codec {
	cachedCodecChangelogLock.Lock()
	...
	cachedCodecChangelogLock.Unlock()
...
func (o *Changelog) ToMap(avro ...bool) map[string]interface{} {
	...
	o.setDefaults(false)
	return map[string]interface{}{
		"created_date": toChangelogObject(o.CreatedDate, isavro, false, "created_date"),
...
func GetChangelogAvroSchemaSpec() string {
	spec := map[string]interface{}{
		...
		"fields": []map[string]interface{}{
			...
			map[string]interface{}{
				"name": "created_date",
				"type": map[string]interface{}{"doc": "the date when this change was created", "fields": []interface{}{map[string]interface{}{"doc": "the date in epoch format", "name": "epoch", "type": "long"}, map[string]interface{}{"doc": "the timezone offset from GMT", "name": "offset", "type": "long"}, map[string]interface{}{"doc": "the date in RFC3339 format", "name": "rfc3339", "type": "string"}}, "name": "created_date", "type": "record"},
			},
			map[string]interface{}{
				"name": "customer_id",
				"type": "string",
