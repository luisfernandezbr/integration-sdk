...
func GetIssueAvroSchemaSpec() string {
	spec := map[string]interface{}{
		...
		"fields": []map[string]interface{}{
			...
			map[string]interface{}{
				"name": "customFields",
				"type": map[string]interface{}{"name": "customFields", "items": map[string]interface{}{"doc": "list of custom fields and their values", "type": "record", "name": "customFields", "fields": []interface{}{map[string]interface{}{"type": "string", "name": "id", "doc": "the id of the custom field"}, map[string]interface{}{"type": "string", "name": "name", "doc": "the name of the custom field"}, map[string]interface{}{"type": "string", "name": "value", "doc": "the value of the custom field"}}}, "type": "array"},
			},
			map[string]interface{}{
				"name": "parent_id",
				"type": "string",
...
func NewIssueProducer(ctx context.Context, producer eventing.Producer, ch <-chan datamodel.ModelSendEvent, errors chan<- error) <-chan bool {
	done := make(chan bool, 1)
	go func() {
...
func (o *Issue) NewProducerChannel(producer eventing.Producer, errors chan<- error) datamodel.ModelEventProducer {
	...
	return &IssueProducer{
		...
		cancel:   cancel,
		producer: producer,
		done:     NewIssueProducer(newctx, producer, ch, errors),
	}
}
