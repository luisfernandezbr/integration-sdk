...
func GetIssueAvroSchemaSpec() string {
	spec := map[string]interface{}{
		...
		"fields": []map[string]interface{}{
			...
			map[string]interface{}{
				"name": "customFields",
				"type": map[string]interface{}{"type": "array", "name": "customFields", "items": map[string]interface{}{"fields": []interface{}{map[string]interface{}{"doc": "the id of the custom field", "type": "string", "name": "id"}, map[string]interface{}{"type": "string", "name": "name", "doc": "the name of the custom field"}, map[string]interface{}{"name": "value", "doc": "the value of the custom field", "type": "string"}}, "doc": "list of custom fields and their values", "type": "record", "name": "customFields"}},
			},
			map[string]interface{}{
				"name": "customer_id",
				"type": "string",
