...
func toIssueCreatedDateObject(o interface{}, isavro bool, isoptional bool, avrotype string) interface{} {
	...
	// nested => true prefix => IssueCreatedDate name => IssueCreatedDate
	switch v := o.(type) {
...
func toIssueCustomFieldsObject(o interface{}, isavro bool, isoptional bool, avrotype string) interface{} {
	...
	// nested => true prefix => IssueCustomFields name => IssueCustomFields
	switch v := o.(type) {
...
func toIssueDueDateObject(o interface{}, isavro bool, isoptional bool, avrotype string) interface{} {
	...
	// nested => true prefix => IssueDueDate name => IssueDueDate
	switch v := o.(type) {
	case *IssueDueDate:
		return v.ToMap(isavro)
...
func toIssueUpdatedDateObject(o interface{}, isavro bool, isoptional bool, avrotype string) interface{} {
	...
	// nested => true prefix => IssueUpdatedDate name => IssueUpdatedDate
	switch v := o.(type) {
...
func toIssueObject(o interface{}, isavro bool, isoptional bool, avrotype string) interface{} {
	...
	// nested => false prefix => Issue name => Issue
	switch v := o.(type) {
	case *Issue:
		return v.ToMap(isavro)
...
func GetIssueAvroSchemaSpec() string {
	spec := map[string]interface{}{
		...
		"fields": []map[string]interface{}{
			...
			map[string]interface{}{
				"name": "created_date",
				"type": map[string]interface{}{"fields": []interface{}{map[string]interface{}{"type": "long", "name": "epoch", "doc": "the date in epoch format"}, map[string]interface{}{"name": "offset", "doc": "the timezone offset from GMT", "type": "long"}, map[string]interface{}{"name": "rfc3339", "doc": "the date in RFC3339 format", "type": "string"}}, "doc": "the date that the issue was created", "type": "record", "name": "created_date"},
			},
			map[string]interface{}{
				"name": "creator_ref_id",
				"type": "string",
			...
			map[string]interface{}{
				"name": "customFields",
				"type": map[string]interface{}{"type": "array", "name": "customFields", "items": map[string]interface{}{"type": "record", "name": "customFields", "fields": []interface{}{map[string]interface{}{"name": "id", "doc": "the id of the custom field", "type": "string"}, map[string]interface{}{"type": "string", "name": "name", "doc": "the name of the custom field"}, map[string]interface{}{"type": "string", "name": "value", "doc": "the value of the custom field"}}, "doc": "list of custom fields and their values"}},
			},
			map[string]interface{}{
				"name": "customer_id",
				"type": "string",
