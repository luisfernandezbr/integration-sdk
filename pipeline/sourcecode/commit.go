...
func toCommitAuthorObjectNil(isavro bool, isoptional bool) interface{} {
...
func toCommitAuthorObject(o interface{}, isavro bool, isoptional bool, avrotype string) interface{} {
...
func (o *CommitAuthor) ToMap(avro ...bool) map[string]interface{} {
	var isavro bool
	...
	return map[string]interface{}{
		// ID the corporate user id
		"id": toCommitAuthorObject(o.ID, isavro, false, "string"),
		// TeamID the corporate team id
		"team_id": toCommitAuthorObject(o.TeamID, isavro, false, "string"),
	}
}

func (o *CommitAuthor) setDefaults(frommap bool) {
...
func (o *CommitAuthor) FromMap(kv map[string]interface{}) {
...
func toCommitCommitterObjectNil(isavro bool, isoptional bool) interface{} {
	if isavro && isoptional {
		return goavro.Union("null", nil)
	}
	return nil
...
func toCommitCommitterObject(o interface{}, isavro bool, isoptional bool, avrotype string) interface{} {
	if res, ok := datamodel.ToGolangObject(o, isavro, isoptional, avrotype); ok {
		return res
	}
	switch v := o.(type) {
...
func (o *CommitCommitter) ToMap(avro ...bool) map[string]interface{} {
	var isavro bool
	if len(avro) > 0 && avro[0] {
		isavro = true
	}
	...
	return map[string]interface{}{
		// ID the corporate user id
		"id": toCommitCommitterObject(o.ID, isavro, false, "string"),
		// TeamID the corporate team id
		"team_id": toCommitCommitterObject(o.TeamID, isavro, false, "string"),
	}
}

func (o *CommitCommitter) setDefaults(frommap bool) {
...
// FromMap attempts to load data into object from a map
func (o *CommitCommitter) FromMap(kv map[string]interface{}) {
...
func (o *Commit) FromMap(kv map[string]interface{}) {
	...
	if val, ok := kv["author"]; ok {
		if kv, ok := val.(map[string]interface{}); ok {
			o.Author.FromMap(kv)
		} else if sv, ok := val.(CommitAuthor); ok {
			// struct
			o.Author = sv
		} else if sp, ok := val.(*CommitAuthor); ok {
			// struct pointer
			o.Author = *sp
		}
	} else {
	...
	if val, ok := kv["committer"]; ok {
		if kv, ok := val.(map[string]interface{}); ok {
			o.Committer.FromMap(kv)
		} else if sv, ok := val.(CommitCommitter); ok {
			// struct
			o.Committer = sv
		} else if sp, ok := val.(*CommitCommitter); ok {
			// struct pointer
			o.Committer = *sp
		}
	} else {
		o.Committer.FromMap(map[string]interface{}{})
	}
...
func GetCommitAvroSchemaSpec() string {
	spec := map[string]interface{}{
		...
		"fields": []map[string]interface{}{
			...
			map[string]interface{}{
				"name": "committer",
				"type": map[string]interface{}{"doc": "the committer that commmitted the commit", "type": "record", "name": "committer", "fields": []interface{}{map[string]interface{}{"name": "id", "doc": "the corporate user id", "type": "string"}, map[string]interface{}{"doc": "the corporate team id", "type": "string", "name": "team_id"}}},
			},
			map[string]interface{}{
			...
			map[string]interface{}{
				"name": "files",
				"type": map[string]interface{}{"name": "files", "items": map[string]interface{}{"type": "record", "name": "files", "fields": []interface{}{map[string]interface{}{"type": "long", "name": "additions", "doc": "the number of additions for the commit file"}, map[string]interface{}{"type": "boolean", "name": "binary", "doc": "indicates if the file was detected to be a binary file"}, map[string]interface{}{"type": "long", "name": "blanks", "doc": "the number of blank lines in the file"}, map[string]interface{}{"type": "long", "name": "comments", "doc": "the number of comment lines in the file"}, map[string]interface{}{"type": "string", "name": "commit_id", "doc": "the unique id for the commit"}, map[string]interface{}{"type": "long", "name": "complexity", "doc": "the complexity value for the file change"}, map[string]interface{}{"type": map[string]interface{}{"fields": []interface{}{map[string]interface{}{"type": "long", "name": "epoch", "doc": "the date in epoch format"}, map[string]interface{}{"type": "long", "name": "offset", "doc": "the timezone offset from GMT"}, map[string]interface{}{"type": "string", "name": "rfc3339", "doc": "the date in RFC3339 format"}}, "doc": "the timestamp in UTC that the commit was created", "type": "record", "name": "files.created_date"}, "name": "created_date", "doc": "the timestamp in UTC that the commit was created"}, map[string]interface{}{"type": "long", "name": "deletions", "doc": "the number of deletions for the commit file"}, map[string]interface{}{"doc": "if the file was excluded from processing", "type": "boolean", "name": "excluded"}, map[string]interface{}{"type": "string", "name": "excluded_reason", "doc": "if the file was excluded, the reason"}, map[string]interface{}{"doc": "the filename", "type": "string", "name": "filename"}, map[string]interface{}{"name": "language", "doc": "the language that was detected for the file", "type": "string"}, map[string]interface{}{"type": "string", "name": "license", "doc": "the license which was detected for the file"}, map[string]interface{}{"type": "float", "name": "license_confidence", "doc": "the license confidence from the detection engine"}, map[string]interface{}{"doc": "the number of lines in the file", "type": "long", "name": "loc"}, map[string]interface{}{"type": "long", "name": "ordinal", "doc": "the order value for the file in the change set"}, map[string]interface{}{"type": "boolean", "name": "renamed", "doc": "if the file was renamed"}, map[string]interface{}{"doc": "the original file name", "type": "string", "name": "renamed_from"}, map[string]interface{}{"type": "string", "name": "renamed_to", "doc": "the final file name"}, map[string]interface{}{"type": "string", "name": "repo_id", "doc": "the unique id for the repo"}, map[string]interface{}{"type": "long", "name": "size", "doc": "the size of the file"}, map[string]interface{}{"name": "sloc", "doc": "the number of source lines in the file", "type": "long"}, map[string]interface{}{"type": "string", "name": "status", "doc": "the status of the change"}}, "doc": "the files touched by this commit"}, "type": "array"},
			},
			map[string]interface{}{
				"name": "files_changed",
				"type": "long",
