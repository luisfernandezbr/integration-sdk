...
const (
	...
	// SignalCalculatedDateColumn is the calculated_date column name
	SignalCalculatedDateColumn = "calculated_date"
	// SignalCalculatedDateColumnEpochColumn is the epoch column property of the CalculatedDate name
	SignalCalculatedDateColumnEpochColumn = "calculated_date->epoch"
	// SignalCalculatedDateColumnOffsetColumn is the offset column property of the CalculatedDate name
...
func (o *SignalCalculatedDate) ToMap() map[string]interface{} {
...
func toSignalObject(o interface{}, isavro bool, isoptional bool, avrotype string) interface{} {
	...
	case SignalCalculatedDate:
		vv := o.(SignalCalculatedDate)
		return vv.ToMap()
	}
...
func (o *Signal) GetTimestamp() time.Time {
	var dt interface{} = o.CalculatedDate
	switch v := dt.(type) {
	case int64:
...
func (o *Signal) FromMap(kv map[string]interface{}) {
	...
	if val, ok := kv["calculated_date"].(SignalCalculatedDate); ok {
		o.CalculatedDate = val
	} else {
		val := kv["calculated_date"]
		if val == nil {
			o.CalculatedDate = SignalCalculatedDate{}
		} else {
			o.CalculatedDate = SignalCalculatedDate{}
	...
	spec := map[string]interface{}{
		...
		"fields": []map[string]interface{}{
			...
			map[string]interface{}{
				...
				"type": map[string]interface{}{"fields": []interface{}{map[string]interface{}{"type": "long", "name": "epoch", "doc": "the date in epoch format"}, map[string]interface{}{"type": "long", "name": "offset", "doc": "the timezone offset from GMT"}, map[string]interface{}{"name": "rfc3339", "doc": "the date in RFC3339 format", "type": "string"}}, "doc": "the date when the signal was calculated", "type": "record", "name": "calculated_date"},
			},
			map[string]interface{}{
				"name": "current",
				"type": "boolean",
...
func (o *Signal) GetEventAPIConfig() datamodel.EventAPIConfig {
		...
		OnDataReceived: func(msg eventing.Message) error {
			...
			case eventing.AvroEncoding:
				if err := object.FromAvroBinary(msg.Value); err != nil {
					return fmt.Errorf("error unmarshaling avro data into pipeline.signal.Signal: %s", err)
				}
			default:
