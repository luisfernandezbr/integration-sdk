...
func GetActivityAvroSchemaSpec() string {
	spec := map[string]interface{}{
		...
		"fields": []map[string]interface{}{
			...
			map[string]interface{}{
				"name": "user",
				"type": map[string]interface{}{"doc": "the user related to the activity", "type": "record", "name": "user", "fields": []interface{}{map[string]interface{}{"name": "id", "doc": "the corporate user id", "type": "string"}, map[string]interface{}{"name": "team_id", "doc": "the corporate team id", "type": "string"}}},
			},
		},
	}
