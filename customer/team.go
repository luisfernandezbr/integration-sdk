...
func (o *Team) SetCustomerID(id string) {
	o.CustomerID = id
}

// GetRefType will return the ref_type
func (o *Team) GetRefType() string {
	return o.RefType
}
...
func (o *Team) SetIntegrationInstanceID(id string) {
	if id == "" {
...
func (o *Team) GetIntegrationInstanceID() *string {
