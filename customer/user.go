...
func toUserObject(o interface{}, isavro bool, isoptional bool, avrotype string) interface{} {
	...
	case *UserDeleted:
		return map[string]interface{}{
			"customer.deleted": (*o.(*UserDeleted)).ToMap(),
		}
	case []UserDeleted:
		arr := make([]interface{}, 0)
	...
	case *UserHired:
		return map[string]interface{}{
			"customer.hired": (*o.(*UserHired)).ToMap(),
		}
	case []UserHired:
		arr := make([]interface{}, 0)
	...
	case *UserTerminated:
		return map[string]interface{}{
			"customer.terminated": (*o.(*UserTerminated)).ToMap(),
		}
	case []UserTerminated:
		arr := make([]interface{}, 0)
