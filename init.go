...
func GetMaterializedTopics() []datamodel.TopicNameType {
	return []datamodel.TopicNameType{
		datamodel.TopicNameType("pipeline.signal_Signal_topic"),
		datamodel.TopicNameType("pipeline.activity_Activity_topic"),
		datamodel.TopicNameType("work_Project_topic"),
		datamodel.TopicNameType("pipeline.integration_User_topic"),
		datamodel.TopicNameType("pipeline.work_CustomField_topic"),
		...
		datamodel.TopicNameType("pipeline.sourcecode_Commit_topic"),
...
func GetTopics() []datamodel.TopicNameType {
	return []datamodel.TopicNameType{
		...
		datamodel.TopicNameType("pipeline.activity_Activity_topic"),
		datamodel.TopicNameType("pipeline.customer_User_topic"),
		...
		datamodel.TopicNameType("customer_User_topic"),
		datamodel.TopicNameType("auth_ACLGrant_topic"),
		datamodel.TopicNameType("ops.db_Change_topic"),
		datamodel.TopicNameType("pipeline.sourcecode_Commit_topic"),
		datamodel.TopicNameType("admin_Agent_topic"),
	}
}
