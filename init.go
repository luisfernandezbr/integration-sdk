...
func New(name datamodel.ModelNameType) datamodel.Model {
	...
	case "agent.ExportResponse":
		...
		o.FromMap(map[string]interface{}{})
		return o
	case "agent.ExportStat":
		o := new(dm_agent.ExportStat)
		o.FromMap(map[string]interface{}{})
		return o
	case "agent.ExportTrigger":
		...
		o.FromMap(map[string]interface{}{})
		return o
	case "agent.IntegrationCapability":
		o := new(dm_agent.IntegrationCapability)
		o.FromMap(map[string]interface{}{})
		return o
	case "agent.IntegrationInstance":
		...
		o.FromMap(map[string]interface{}{})
		return o
	case "agent.IntegrationInstanceStat":
		o := new(dm_agent.IntegrationInstanceStat)
		o.FromMap(map[string]interface{}{})
		return o
...
func NewPartial(name datamodel.ModelNameType) datamodel.PartialModel {
	...
	case "agent.ExportStat":
		return new(dm_agent.ExportStatPartial)
	case "agent.ExportTrigger":
		return new(dm_agent.ExportTriggerPartial)
	case "agent.IntegrationCapability":
		return new(dm_agent.IntegrationCapabilityPartial)
	case "agent.IntegrationInstance":
		return new(dm_agent.IntegrationInstancePartial)
	case "agent.IntegrationInstanceStat":
		return new(dm_agent.IntegrationInstanceStatPartial)
	case "agent.IntegrationMutationRequest":
	...
	case "work.Board":
		return new(dm_work.BoardPartial)
	case "work.Config":
	...
	case "work.Kanban":
		return new(dm_work.KanbanPartial)
	case "work.Project":
...
func GetTopics() []datamodel.TopicNameType {
	return []datamodel.TopicNameType{
		...
		datamodel.TopicNameType("work_Board"),
		datamodel.TopicNameType("work_Config"),
		datamodel.TopicNameType("work_Kanban"),
...
func GetModelNames() []datamodel.ModelNameType {
	return []datamodel.ModelNameType{
		...
		datamodel.ModelNameType("agent.ExportStat"),
		datamodel.ModelNameType("agent.ExportTrigger"),
		datamodel.ModelNameType("agent.IntegrationCapability"),
		datamodel.ModelNameType("agent.IntegrationInstance"),
		datamodel.ModelNameType("agent.IntegrationInstanceStat"),
		...
		datamodel.ModelNameType("work.Board"),
		...
		datamodel.ModelNameType("work.Kanban"),
