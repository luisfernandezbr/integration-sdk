...
func (o *CommitFile) GetTimestamp() time.Time {
	...
	panic("not sure how to handle the date time format for CommitFile")
}
...
func (o *CommitFile) Clone() datamodel.Model {
	c := new(CommitFile)
	c.FromMap(o.ToMap())
	return c
}
...
func (o *CommitFile) Anon() datamodel.Model {
	c := new(CommitFile)
