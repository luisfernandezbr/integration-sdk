...
type Build struct {
	...
	EndDate BuildEndDate `json:"end_date" yaml:"end_date" faker:"-"`
	// Environment the environment for the build
	Environment BuildEnvironment `json:"environment" yaml:"environment" faker:"-"`
	...
	StartDate BuildStartDate `json:"start_date" yaml:"start_date" faker:"-"`
	// Status the status of the build
	Status BuildStatus `json:"status" yaml:"status" faker:"-"`
